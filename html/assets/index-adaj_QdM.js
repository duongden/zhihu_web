const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/HomeView-DSBK7LZz.js","assets/mockData-QDqH7q9Q.js","assets/HomeView-BazLS6A2.css","assets/FollowingView-DFRLmooN.js","assets/FollowingView-DC-KEoGA.css","assets/CollectionsView-DndVy27c.js","assets/CollectionsView-CbhkfhHH.css","assets/DailyView-DMVIsebS.js","assets/DailyView-7JiscOoy.css","assets/HistoryView-B_uoSlWY.js","assets/HistoryView-CL9thsIa.css","assets/SettingsView-BF39N0Lz.js","assets/SettingsView-CxMIjo8S.css"])))=>i.map(i=>d[i]);
(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();function e(e){let t=Object.create(null);for(let n of e.split(`,`))t[n]=1;return e=>e in t}var t={},n=[],r=()=>{},i=()=>!1,a=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&(e.charCodeAt(2)>122||e.charCodeAt(2)<97),o=e=>e.startsWith(`onUpdate:`),s=Object.assign,c=(e,t)=>{let n=e.indexOf(t);n>-1&&e.splice(n,1)},l=Object.prototype.hasOwnProperty,u=(e,t)=>l.call(e,t),d=Array.isArray,f=e=>x(e)===`[object Map]`,p=e=>x(e)===`[object Set]`,m=e=>x(e)===`[object RegExp]`,h=e=>typeof e==`function`,g=e=>typeof e==`string`,_=e=>typeof e==`symbol`,v=e=>typeof e==`object`&&!!e,y=e=>(v(e)||h(e))&&h(e.then)&&h(e.catch),b=Object.prototype.toString,x=e=>b.call(e),ee=e=>x(e).slice(8,-1),S=e=>x(e)===`[object Object]`,te=e=>g(e)&&e!==`NaN`&&e[0]!==`-`&&``+parseInt(e,10)===e,ne=e(`,key,ref,ref_for,ref_key,onVnodeBeforeMount,onVnodeMounted,onVnodeBeforeUpdate,onVnodeUpdated,onVnodeBeforeUnmount,onVnodeUnmounted`),re=e=>{let t=Object.create(null);return(n=>t[n]||(t[n]=e(n)))},ie=/-\w/g,C=re(e=>e.replace(ie,e=>e.slice(1).toUpperCase())),ae=/\B([A-Z])/g,oe=re(e=>e.replace(ae,`-$1`).toLowerCase()),se=re(e=>e.charAt(0).toUpperCase()+e.slice(1)),ce=re(e=>e?`on${se(e)}`:``),le=(e,t)=>!Object.is(e,t),ue=(e,...t)=>{for(let n=0;n<e.length;n++)e[n](...t)},w=(e,t,n,r=!1)=>{Object.defineProperty(e,t,{configurable:!0,enumerable:!1,writable:r,value:n})},de=e=>{let t=parseFloat(e);return isNaN(t)?e:t},fe,pe=()=>fe||=typeof globalThis<`u`?globalThis:typeof self<`u`?self:typeof window<`u`?window:typeof global<`u`?global:{};function T(e){if(d(e)){let t={};for(let n=0;n<e.length;n++){let r=e[n],i=g(r)?_e(r):T(r);if(i)for(let e in i)t[e]=i[e]}return t}else if(g(e)||v(e))return e}var me=/;(?![^(]*\))/g,he=/:([^]+)/,ge=/\/\*[^]*?\*\//g;function _e(e){let t={};return e.replace(ge,``).split(me).forEach(e=>{if(e){let n=e.split(he);n.length>1&&(t[n[0].trim()]=n[1].trim())}}),t}function ve(e){let t=``;if(g(e))t=e;else if(d(e))for(let n=0;n<e.length;n++){let r=ve(e[n]);r&&(t+=r+` `)}else if(v(e))for(let n in e)e[n]&&(t+=n+` `);return t.trim()}var ye=`itemscope,allowfullscreen,formnovalidate,ismap,nomodule,novalidate,readonly`,be=e(ye);ye+``;function xe(e){return!!e||e===``}var Se=e=>!!(e&&e.__v_isRef===!0),E=e=>g(e)?e:e==null?``:d(e)||v(e)&&(e.toString===b||!h(e.toString))?Se(e)?E(e.value):JSON.stringify(e,Ce,2):String(e),Ce=(e,t)=>Se(t)?Ce(e,t.value):f(t)?{[`Map(${t.size})`]:[...t.entries()].reduce((e,[t,n],r)=>(e[we(t,r)+` =>`]=n,e),{})}:p(t)?{[`Set(${t.size})`]:[...t.values()].map(e=>we(e))}:_(t)?we(t):v(t)&&!d(t)&&!S(t)?String(t):t,we=(e,t=``)=>_(e)?`Symbol(${e.description??t})`:e,D,Te=class{constructor(e=!1){this.detached=e,this._active=!0,this._on=0,this.effects=[],this.cleanups=[],this._isPaused=!1,this.parent=D,!e&&D&&(this.index=(D.scopes||=[]).push(this)-1)}get active(){return this._active}pause(){if(this._active){this._isPaused=!0;let e,t;if(this.scopes)for(e=0,t=this.scopes.length;e<t;e++)this.scopes[e].pause();for(e=0,t=this.effects.length;e<t;e++)this.effects[e].pause()}}resume(){if(this._active&&this._isPaused){this._isPaused=!1;let e,t;if(this.scopes)for(e=0,t=this.scopes.length;e<t;e++)this.scopes[e].resume();for(e=0,t=this.effects.length;e<t;e++)this.effects[e].resume()}}run(e){if(this._active){let t=D;try{return D=this,e()}finally{D=t}}}on(){++this._on===1&&(this.prevScope=D,D=this)}off(){this._on>0&&--this._on===0&&(D=this.prevScope,this.prevScope=void 0)}stop(e){if(this._active){this._active=!1;let t,n;for(t=0,n=this.effects.length;t<n;t++)this.effects[t].stop();for(this.effects.length=0,t=0,n=this.cleanups.length;t<n;t++)this.cleanups[t]();if(this.cleanups.length=0,this.scopes){for(t=0,n=this.scopes.length;t<n;t++)this.scopes[t].stop(!0);this.scopes.length=0}if(!this.detached&&this.parent&&!e){let e=this.parent.scopes.pop();e&&e!==this&&(this.parent.scopes[this.index]=e,e.index=this.index)}this.parent=void 0}}};function Ee(){return D}var O,De=new WeakSet,Oe=class{constructor(e){this.fn=e,this.deps=void 0,this.depsTail=void 0,this.flags=5,this.next=void 0,this.cleanup=void 0,this.scheduler=void 0,D&&D.active&&D.effects.push(this)}pause(){this.flags|=64}resume(){this.flags&64&&(this.flags&=-65,De.has(this)&&(De.delete(this),this.trigger()))}notify(){this.flags&2&&!(this.flags&32)||this.flags&8||Me(this)}run(){if(!(this.flags&1))return this.fn();this.flags|=2,Ge(this),Fe(this);let e=O,t=Ve;O=this,Ve=!0;try{return this.fn()}finally{Ie(this),O=e,Ve=t,this.flags&=-3}}stop(){if(this.flags&1){for(let e=this.deps;e;e=e.nextDep)ze(e);this.deps=this.depsTail=void 0,Ge(this),this.onStop&&this.onStop(),this.flags&=-2}}trigger(){this.flags&64?De.add(this):this.scheduler?this.scheduler():this.runIfDirty()}runIfDirty(){Le(this)&&this.run()}get dirty(){return Le(this)}},ke=0,Ae,je;function Me(e,t=!1){if(e.flags|=8,t){e.next=je,je=e;return}e.next=Ae,Ae=e}function Ne(){ke++}function Pe(){if(--ke>0)return;if(je){let e=je;for(je=void 0;e;){let t=e.next;e.next=void 0,e.flags&=-9,e=t}}let e;for(;Ae;){let t=Ae;for(Ae=void 0;t;){let n=t.next;if(t.next=void 0,t.flags&=-9,t.flags&1)try{t.trigger()}catch(t){e||=t}t=n}}if(e)throw e}function Fe(e){for(let t=e.deps;t;t=t.nextDep)t.version=-1,t.prevActiveLink=t.dep.activeLink,t.dep.activeLink=t}function Ie(e){let t,n=e.depsTail,r=n;for(;r;){let e=r.prevDep;r.version===-1?(r===n&&(n=e),ze(r),Be(r)):t=r,r.dep.activeLink=r.prevActiveLink,r.prevActiveLink=void 0,r=e}e.deps=t,e.depsTail=n}function Le(e){for(let t=e.deps;t;t=t.nextDep)if(t.dep.version!==t.version||t.dep.computed&&(Re(t.dep.computed)||t.dep.version!==t.version))return!0;return!!e._dirty}function Re(e){if(e.flags&4&&!(e.flags&16)||(e.flags&=-17,e.globalVersion===Ke)||(e.globalVersion=Ke,!e.isSSR&&e.flags&128&&(!e.deps&&!e._dirty||!Le(e))))return;e.flags|=2;let t=e.dep,n=O,r=Ve;O=e,Ve=!0;try{Fe(e);let n=e.fn(e._value);(t.version===0||le(n,e._value))&&(e.flags|=128,e._value=n,t.version++)}catch(e){throw t.version++,e}finally{O=n,Ve=r,Ie(e),e.flags&=-3}}function ze(e,t=!1){let{dep:n,prevSub:r,nextSub:i}=e;if(r&&(r.nextSub=i,e.prevSub=void 0),i&&(i.prevSub=r,e.nextSub=void 0),n.subs===e&&(n.subs=r,!r&&n.computed)){n.computed.flags&=-5;for(let e=n.computed.deps;e;e=e.nextDep)ze(e,!0)}!t&&!--n.sc&&n.map&&n.map.delete(n.key)}function Be(e){let{prevDep:t,nextDep:n}=e;t&&(t.nextDep=n,e.prevDep=void 0),n&&(n.prevDep=t,e.nextDep=void 0)}var Ve=!0,He=[];function Ue(){He.push(Ve),Ve=!1}function We(){let e=He.pop();Ve=e===void 0?!0:e}function Ge(e){let{cleanup:t}=e;if(e.cleanup=void 0,t){let e=O;O=void 0;try{t()}finally{O=e}}}var Ke=0,qe=class{constructor(e,t){this.sub=e,this.dep=t,this.version=t.version,this.nextDep=this.prevDep=this.nextSub=this.prevSub=this.prevActiveLink=void 0}},Je=class{constructor(e){this.computed=e,this.version=0,this.activeLink=void 0,this.subs=void 0,this.map=void 0,this.key=void 0,this.sc=0,this.__v_skip=!0}track(e){if(!O||!Ve||O===this.computed)return;let t=this.activeLink;if(t===void 0||t.sub!==O)t=this.activeLink=new qe(O,this),O.deps?(t.prevDep=O.depsTail,O.depsTail.nextDep=t,O.depsTail=t):O.deps=O.depsTail=t,Ye(t);else if(t.version===-1&&(t.version=this.version,t.nextDep)){let e=t.nextDep;e.prevDep=t.prevDep,t.prevDep&&(t.prevDep.nextDep=e),t.prevDep=O.depsTail,t.nextDep=void 0,O.depsTail.nextDep=t,O.depsTail=t,O.deps===t&&(O.deps=e)}return t}trigger(e){this.version++,Ke++,this.notify(e)}notify(e){Ne();try{for(let e=this.subs;e;e=e.prevSub)e.sub.notify()&&e.sub.dep.notify()}finally{Pe()}}};function Ye(e){if(e.dep.sc++,e.sub.flags&4){let t=e.dep.computed;if(t&&!e.dep.subs){t.flags|=20;for(let e=t.deps;e;e=e.nextDep)Ye(e)}let n=e.dep.subs;n!==e&&(e.prevSub=n,n&&(n.nextSub=e)),e.dep.subs=e}}var Xe=new WeakMap,Ze=Symbol(``),Qe=Symbol(``),$e=Symbol(``);function k(e,t,n){if(Ve&&O){let t=Xe.get(e);t||Xe.set(e,t=new Map);let r=t.get(n);r||(t.set(n,r=new Je),r.map=t,r.key=n),r.track()}}function et(e,t,n,r,i,a){let o=Xe.get(e);if(!o){Ke++;return}let s=e=>{e&&e.trigger()};if(Ne(),t===`clear`)o.forEach(s);else{let i=d(e),a=i&&te(n);if(i&&n===`length`){let e=Number(r);o.forEach((t,n)=>{(n===`length`||n===$e||!_(n)&&n>=e)&&s(t)})}else switch((n!==void 0||o.has(void 0))&&s(o.get(n)),a&&s(o.get($e)),t){case`add`:i?a&&s(o.get(`length`)):(s(o.get(Ze)),f(e)&&s(o.get(Qe)));break;case`delete`:i||(s(o.get(Ze)),f(e)&&s(o.get(Qe)));break;case`set`:f(e)&&s(o.get(Ze));break}}Pe()}function tt(e){let t=A(e);return t===e?t:(k(t,`iterate`,$e),Vt(e)?t:t.map(Wt))}function nt(e){return k(e=A(e),`iterate`,$e),e}function rt(e,t){return Bt(e)?zt(e)?Gt(Wt(t)):Gt(t):Wt(t)}var it={__proto__:null,[Symbol.iterator](){return at(this,Symbol.iterator,e=>rt(this,e))},concat(...e){return tt(this).concat(...e.map(e=>d(e)?tt(e):e))},entries(){return at(this,`entries`,e=>(e[1]=rt(this,e[1]),e))},every(e,t){return st(this,`every`,e,t,void 0,arguments)},filter(e,t){return st(this,`filter`,e,t,e=>e.map(e=>rt(this,e)),arguments)},find(e,t){return st(this,`find`,e,t,e=>rt(this,e),arguments)},findIndex(e,t){return st(this,`findIndex`,e,t,void 0,arguments)},findLast(e,t){return st(this,`findLast`,e,t,e=>rt(this,e),arguments)},findLastIndex(e,t){return st(this,`findLastIndex`,e,t,void 0,arguments)},forEach(e,t){return st(this,`forEach`,e,t,void 0,arguments)},includes(...e){return lt(this,`includes`,e)},indexOf(...e){return lt(this,`indexOf`,e)},join(e){return tt(this).join(e)},lastIndexOf(...e){return lt(this,`lastIndexOf`,e)},map(e,t){return st(this,`map`,e,t,void 0,arguments)},pop(){return ut(this,`pop`)},push(...e){return ut(this,`push`,e)},reduce(e,...t){return ct(this,`reduce`,e,t)},reduceRight(e,...t){return ct(this,`reduceRight`,e,t)},shift(){return ut(this,`shift`)},some(e,t){return st(this,`some`,e,t,void 0,arguments)},splice(...e){return ut(this,`splice`,e)},toReversed(){return tt(this).toReversed()},toSorted(e){return tt(this).toSorted(e)},toSpliced(...e){return tt(this).toSpliced(...e)},unshift(...e){return ut(this,`unshift`,e)},values(){return at(this,`values`,e=>rt(this,e))}};function at(e,t,n){let r=nt(e),i=r[t]();return r!==e&&!Vt(e)&&(i._next=i.next,i.next=()=>{let e=i._next();return e.done||(e.value=n(e.value)),e}),i}var ot=Array.prototype;function st(e,t,n,r,i,a){let o=nt(e),s=o!==e&&!Vt(e),c=o[t];if(c!==ot[t]){let t=c.apply(e,a);return s?Wt(t):t}let l=n;o!==e&&(s?l=function(t,r){return n.call(this,rt(e,t),r,e)}:n.length>2&&(l=function(t,r){return n.call(this,t,r,e)}));let u=c.call(o,l,r);return s&&i?i(u):u}function ct(e,t,n,r){let i=nt(e),a=n;return i!==e&&(Vt(e)?n.length>3&&(a=function(t,r,i){return n.call(this,t,r,i,e)}):a=function(t,r,i){return n.call(this,t,rt(e,r),i,e)}),i[t](a,...r)}function lt(e,t,n){let r=A(e);k(r,`iterate`,$e);let i=r[t](...n);return(i===-1||i===!1)&&Ht(n[0])?(n[0]=A(n[0]),r[t](...n)):i}function ut(e,t,n=[]){Ue(),Ne();let r=A(e)[t].apply(e,n);return Pe(),We(),r}var dt=e(`__proto__,__v_isRef,__isVue`),ft=new Set(Object.getOwnPropertyNames(Symbol).filter(e=>e!==`arguments`&&e!==`caller`).map(e=>Symbol[e]).filter(_));function pt(e){_(e)||(e=String(e));let t=A(this);return k(t,`has`,e),t.hasOwnProperty(e)}var mt=class{constructor(e=!1,t=!1){this._isReadonly=e,this._isShallow=t}get(e,t,n){if(t===`__v_skip`)return e.__v_skip;let r=this._isReadonly,i=this._isShallow;if(t===`__v_isReactive`)return!r;if(t===`__v_isReadonly`)return r;if(t===`__v_isShallow`)return i;if(t===`__v_raw`)return n===(r?i?Mt:jt:i?At:kt).get(e)||Object.getPrototypeOf(e)===Object.getPrototypeOf(n)?e:void 0;let a=d(e);if(!r){let e;if(a&&(e=it[t]))return e;if(t===`hasOwnProperty`)return pt}let o=Reflect.get(e,t,j(e)?e:n);if((_(t)?ft.has(t):dt(t))||(r||k(e,`get`,t),i))return o;if(j(o)){let e=a&&te(t)?o:o.value;return r&&v(e)?Lt(e):e}return v(o)?r?Lt(o):Ft(o):o}},ht=class extends mt{constructor(e=!1){super(!1,e)}set(e,t,n,r){let i=e[t],a=d(e)&&te(t);if(!this._isShallow){let e=Bt(i);if(!Vt(n)&&!Bt(n)&&(i=A(i),n=A(n)),!a&&j(i)&&!j(n))return e||(i.value=n),!0}let o=a?Number(t)<e.length:u(e,t),s=Reflect.set(e,t,n,j(e)?e:r);return e===A(r)&&(o?le(n,i)&&et(e,`set`,t,n,i):et(e,`add`,t,n)),s}deleteProperty(e,t){let n=u(e,t),r=e[t],i=Reflect.deleteProperty(e,t);return i&&n&&et(e,`delete`,t,void 0,r),i}has(e,t){let n=Reflect.has(e,t);return(!_(t)||!ft.has(t))&&k(e,`has`,t),n}ownKeys(e){return k(e,`iterate`,d(e)?`length`:Ze),Reflect.ownKeys(e)}},gt=class extends mt{constructor(e=!1){super(!0,e)}set(e,t){return!0}deleteProperty(e,t){return!0}},_t=new ht,vt=new gt,yt=new ht(!0),bt=e=>e,xt=e=>Reflect.getPrototypeOf(e);function St(e,t,n){return function(...r){let i=this.__v_raw,a=A(i),o=f(a),s=e===`entries`||e===Symbol.iterator&&o,c=e===`keys`&&o,l=i[e](...r),u=n?bt:t?Gt:Wt;return!t&&k(a,`iterate`,c?Qe:Ze),{next(){let{value:e,done:t}=l.next();return t?{value:e,done:t}:{value:s?[u(e[0]),u(e[1])]:u(e),done:t}},[Symbol.iterator](){return this}}}}function Ct(e){return function(...t){return e===`delete`?!1:e===`clear`?void 0:this}}function wt(e,t){let n={get(n){let r=this.__v_raw,i=A(r),a=A(n);e||(le(n,a)&&k(i,`get`,n),k(i,`get`,a));let{has:o}=xt(i),s=t?bt:e?Gt:Wt;if(o.call(i,n))return s(r.get(n));if(o.call(i,a))return s(r.get(a));r!==i&&r.get(n)},get size(){let t=this.__v_raw;return!e&&k(A(t),`iterate`,Ze),t.size},has(t){let n=this.__v_raw,r=A(n),i=A(t);return e||(le(t,i)&&k(r,`has`,t),k(r,`has`,i)),t===i?n.has(t):n.has(t)||n.has(i)},forEach(n,r){let i=this,a=i.__v_raw,o=A(a),s=t?bt:e?Gt:Wt;return!e&&k(o,`iterate`,Ze),a.forEach((e,t)=>n.call(r,s(e),s(t),i))}};return s(n,e?{add:Ct(`add`),set:Ct(`set`),delete:Ct(`delete`),clear:Ct(`clear`)}:{add(e){!t&&!Vt(e)&&!Bt(e)&&(e=A(e));let n=A(this);return xt(n).has.call(n,e)||(n.add(e),et(n,`add`,e,e)),this},set(e,n){!t&&!Vt(n)&&!Bt(n)&&(n=A(n));let r=A(this),{has:i,get:a}=xt(r),o=i.call(r,e);o||=(e=A(e),i.call(r,e));let s=a.call(r,e);return r.set(e,n),o?le(n,s)&&et(r,`set`,e,n,s):et(r,`add`,e,n),this},delete(e){let t=A(this),{has:n,get:r}=xt(t),i=n.call(t,e);i||=(e=A(e),n.call(t,e));let a=r?r.call(t,e):void 0,o=t.delete(e);return i&&et(t,`delete`,e,void 0,a),o},clear(){let e=A(this),t=e.size!==0,n=e.clear();return t&&et(e,`clear`,void 0,void 0,void 0),n}}),[`keys`,`values`,`entries`,Symbol.iterator].forEach(r=>{n[r]=St(r,e,t)}),n}function Tt(e,t){let n=wt(e,t);return(t,r,i)=>r===`__v_isReactive`?!e:r===`__v_isReadonly`?e:r===`__v_raw`?t:Reflect.get(u(n,r)&&r in t?n:t,r,i)}var Et={get:Tt(!1,!1)},Dt={get:Tt(!1,!0)},Ot={get:Tt(!0,!1)},kt=new WeakMap,At=new WeakMap,jt=new WeakMap,Mt=new WeakMap;function Nt(e){switch(e){case`Object`:case`Array`:return 1;case`Map`:case`Set`:case`WeakMap`:case`WeakSet`:return 2;default:return 0}}function Pt(e){return e.__v_skip||!Object.isExtensible(e)?0:Nt(ee(e))}function Ft(e){return Bt(e)?e:Rt(e,!1,_t,Et,kt)}function It(e){return Rt(e,!1,yt,Dt,At)}function Lt(e){return Rt(e,!0,vt,Ot,jt)}function Rt(e,t,n,r,i){if(!v(e)||e.__v_raw&&!(t&&e.__v_isReactive))return e;let a=Pt(e);if(a===0)return e;let o=i.get(e);if(o)return o;let s=new Proxy(e,a===2?r:n);return i.set(e,s),s}function zt(e){return Bt(e)?zt(e.__v_raw):!!(e&&e.__v_isReactive)}function Bt(e){return!!(e&&e.__v_isReadonly)}function Vt(e){return!!(e&&e.__v_isShallow)}function Ht(e){return e?!!e.__v_raw:!1}function A(e){let t=e&&e.__v_raw;return t?A(t):e}function Ut(e){return!u(e,`__v_skip`)&&Object.isExtensible(e)&&w(e,`__v_skip`,!0),e}var Wt=e=>v(e)?Ft(e):e,Gt=e=>v(e)?Lt(e):e;function j(e){return e?e.__v_isRef===!0:!1}function M(e){return qt(e,!1)}function Kt(e){return qt(e,!0)}function qt(e,t){return j(e)?e:new Jt(e,t)}var Jt=class{constructor(e,t){this.dep=new Je,this.__v_isRef=!0,this.__v_isShallow=!1,this._rawValue=t?e:A(e),this._value=t?e:Wt(e),this.__v_isShallow=t}get value(){return this.dep.track(),this._value}set value(e){let t=this._rawValue,n=this.__v_isShallow||Vt(e)||Bt(e);e=n?e:A(e),le(e,t)&&(this._rawValue=e,this._value=n?e:Wt(e),this.dep.trigger())}};function Yt(e){return j(e)?e.value:e}var Xt={get:(e,t,n)=>t===`__v_raw`?e:Yt(Reflect.get(e,t,n)),set:(e,t,n,r)=>{let i=e[t];return j(i)&&!j(n)?(i.value=n,!0):Reflect.set(e,t,n,r)}};function Zt(e){return zt(e)?e:new Proxy(e,Xt)}var Qt=class{constructor(e,t,n){this.fn=e,this.setter=t,this._value=void 0,this.dep=new Je(this),this.__v_isRef=!0,this.deps=void 0,this.depsTail=void 0,this.flags=16,this.globalVersion=Ke-1,this.next=void 0,this.effect=this,this.__v_isReadonly=!t,this.isSSR=n}notify(){if(this.flags|=16,!(this.flags&8)&&O!==this)return Me(this,!0),!0}get value(){let e=this.dep.track();return Re(this),e&&(e.version=this.dep.version),this._value}set value(e){this.setter&&this.setter(e)}};function $t(e,t,n=!1){let r,i;return h(e)?r=e:(r=e.get,i=e.set),new Qt(r,i,n)}var en={},tn=new WeakMap,nn=void 0;function rn(e,t=!1,n=nn){if(n){let t=tn.get(n);t||tn.set(n,t=[]),t.push(e)}}function an(e,n,i=t){let{immediate:a,deep:o,once:s,scheduler:l,augmentJob:u,call:f}=i,p=e=>o?e:Vt(e)||o===!1||o===0?on(e,1):on(e),m,g,_,v,y=!1,b=!1;if(j(e)?(g=()=>e.value,y=Vt(e)):zt(e)?(g=()=>p(e),y=!0):d(e)?(b=!0,y=e.some(e=>zt(e)||Vt(e)),g=()=>e.map(e=>{if(j(e))return e.value;if(zt(e))return p(e);if(h(e))return f?f(e,2):e()})):g=h(e)?n?f?()=>f(e,2):e:()=>{if(_){Ue();try{_()}finally{We()}}let t=nn;nn=m;try{return f?f(e,3,[v]):e(v)}finally{nn=t}}:r,n&&o){let e=g,t=o===!0?1/0:o;g=()=>on(e(),t)}let x=Ee(),ee=()=>{m.stop(),x&&x.active&&c(x.effects,m)};if(s&&n){let e=n;n=(...t)=>{e(...t),ee()}}let S=b?Array(e.length).fill(en):en,te=e=>{if(!(!(m.flags&1)||!m.dirty&&!e))if(n){let e=m.run();if(o||y||(b?e.some((e,t)=>le(e,S[t])):le(e,S))){_&&_();let t=nn;nn=m;try{let t=[e,S===en?void 0:b&&S[0]===en?[]:S,v];S=e,f?f(n,3,t):n(...t)}finally{nn=t}}}else m.run()};return u&&u(te),m=new Oe(g),m.scheduler=l?()=>l(te,!1):te,v=e=>rn(e,!1,m),_=m.onStop=()=>{let e=tn.get(m);if(e){if(f)f(e,4);else for(let t of e)t();tn.delete(m)}},n?a?te(!0):S=m.run():l?l(te.bind(null,!0),!0):m.run(),ee.pause=m.pause.bind(m),ee.resume=m.resume.bind(m),ee.stop=ee,ee}function on(e,t=1/0,n){if(t<=0||!v(e)||e.__v_skip||(n||=new Map,(n.get(e)||0)>=t))return e;if(n.set(e,t),t--,j(e))on(e.value,t,n);else if(d(e))for(let r=0;r<e.length;r++)on(e[r],t,n);else if(p(e)||f(e))e.forEach(e=>{on(e,t,n)});else if(S(e)){for(let r in e)on(e[r],t,n);for(let r of Object.getOwnPropertySymbols(e))Object.prototype.propertyIsEnumerable.call(e,r)&&on(e[r],t,n)}return e}function sn(e,t,n,r){try{return r?e(...r):e()}catch(e){ln(e,t,n)}}function cn(e,t,n,r){if(h(e)){let i=sn(e,t,n,r);return i&&y(i)&&i.catch(e=>{ln(e,t,n)}),i}if(d(e)){let i=[];for(let a=0;a<e.length;a++)i.push(cn(e[a],t,n,r));return i}}function ln(e,n,r,i=!0){let a=n?n.vnode:null,{errorHandler:o,throwUnhandledErrorInProduction:s}=n&&n.appContext.config||t;if(n){let t=n.parent,i=n.proxy,a=`https://vuejs.org/error-reference/#runtime-${r}`;for(;t;){let n=t.ec;if(n){for(let t=0;t<n.length;t++)if(n[t](e,i,a)===!1)return}t=t.parent}if(o){Ue(),sn(o,null,10,[e,i,a]),We();return}}un(e,r,a,i,s)}function un(e,t,n,r=!0,i=!1){if(i)throw e;console.error(e)}var N=[],dn=-1,fn=[],pn=null,mn=0,hn=Promise.resolve(),gn=null;function _n(e){let t=gn||hn;return e?t.then(this?e.bind(this):e):t}function vn(e){let t=dn+1,n=N.length;for(;t<n;){let r=t+n>>>1,i=N[r],a=wn(i);a<e||a===e&&i.flags&2?t=r+1:n=r}return t}function yn(e){if(!(e.flags&1)){let t=wn(e),n=N[N.length-1];!n||!(e.flags&2)&&t>=wn(n)?N.push(e):N.splice(vn(t),0,e),e.flags|=1,bn()}}function bn(){gn||=hn.then(Tn)}function xn(e){d(e)?fn.push(...e):pn&&e.id===-1?pn.splice(mn+1,0,e):e.flags&1||(fn.push(e),e.flags|=1),bn()}function Sn(e,t,n=dn+1){for(;n<N.length;n++){let t=N[n];if(t&&t.flags&2){if(e&&t.id!==e.uid)continue;N.splice(n,1),n--,t.flags&4&&(t.flags&=-2),t(),t.flags&4||(t.flags&=-2)}}}function Cn(e){if(fn.length){let e=[...new Set(fn)].sort((e,t)=>wn(e)-wn(t));if(fn.length=0,pn){pn.push(...e);return}for(pn=e,mn=0;mn<pn.length;mn++){let e=pn[mn];e.flags&4&&(e.flags&=-2),e.flags&8||e(),e.flags&=-2}pn=null,mn=0}}var wn=e=>e.id==null?e.flags&2?-1:1/0:e.id;function Tn(e){try{for(dn=0;dn<N.length;dn++){let e=N[dn];e&&!(e.flags&8)&&(e.flags&4&&(e.flags&=-2),sn(e,e.i,e.i?15:14),e.flags&4||(e.flags&=-2))}}finally{for(;dn<N.length;dn++){let e=N[dn];e&&(e.flags&=-2)}dn=-1,N.length=0,Cn(e),gn=null,(N.length||fn.length)&&Tn(e)}}var P=null,En=null;function Dn(e){let t=P;return P=e,En=e&&e.type.__scopeId||null,t}function On(e,t=P,n){if(!t||e._n)return e;let r=(...n)=>{r._d&&Bi(-1);let i=Dn(t),a;try{a=e(...n)}finally{Dn(i),r._d&&Bi(1)}return a};return r._n=!0,r._c=!0,r._d=!0,r}function kn(e,n){if(P===null)return e;let r=ba(P),i=e.dirs||=[];for(let e=0;e<n.length;e++){let[a,o,s,c=t]=n[e];a&&(h(a)&&(a={mounted:a,updated:a}),a.deep&&on(o),i.push({dir:a,instance:r,value:o,oldValue:void 0,arg:s,modifiers:c}))}return e}function An(e,t,n,r){let i=e.dirs,a=t&&t.dirs;for(let o=0;o<i.length;o++){let s=i[o];a&&(s.oldValue=a[o].value);let c=s.dir[r];c&&(Ue(),cn(c,n,8,[e.el,s,e,t]),We())}}var jn=Symbol(`_vte`),Mn=e=>e.__isTeleport,Nn=Symbol(`_leaveCb`);function Pn(e,t){e.shapeFlag&6&&e.component?(e.transition=t,Pn(e.component.subTree,t)):e.shapeFlag&128?(e.ssContent.transition=t.clone(e.ssContent),e.ssFallback.transition=t.clone(e.ssFallback)):e.transition=t}function Fn(e,t){return h(e)?(()=>s({name:e.name},t,{setup:e}))():e}function In(e){e.ids=[e.ids[0]+ e.ids[2]+++`-`,0,0]}var Ln=new WeakMap;function Rn(e,n,r,a,o=!1){if(d(e)){e.forEach((e,t)=>Rn(e,n&&(d(n)?n[t]:n),r,a,o));return}if(Bn(a)&&!o){a.shapeFlag&512&&a.type.__asyncResolved&&a.component.subTree.component&&Rn(e,n,r,a.component.subTree);return}let s=a.shapeFlag&4?ba(a.component):a.el,l=o?null:s,{i:f,r:p}=e,m=n&&n.r,_=f.refs===t?f.refs={}:f.refs,v=f.setupState,y=A(v),b=v===t?i:e=>u(y,e),x=e=>!0;if(m!=null&&m!==p){if(zn(n),g(m))_[m]=null,b(m)&&(v[m]=null);else if(j(m)){x(m)&&(m.value=null);let e=n;e.k&&(_[e.k]=null)}}if(h(p))sn(p,f,12,[l,_]);else{let t=g(p),n=j(p);if(t||n){let i=()=>{if(e.f){let n=t?b(p)?v[p]:_[p]:x(p)||!e.k?p.value:_[e.k];if(o)d(n)&&c(n,s);else if(d(n))n.includes(s)||n.push(s);else if(t)_[p]=[s],b(p)&&(v[p]=_[p]);else{let t=[s];x(p)&&(p.value=t),e.k&&(_[e.k]=t)}}else t?(_[p]=l,b(p)&&(v[p]=l)):n&&(x(p)&&(p.value=l),e.k&&(_[e.k]=l))};if(l){let t=()=>{i(),Ln.delete(e)};t.id=-1,Ln.set(e,t),L(t,r)}else zn(e),i()}}}function zn(e){let t=Ln.get(e);t&&(t.flags|=8,Ln.delete(e))}pe().requestIdleCallback,pe().cancelIdleCallback;var Bn=e=>!!e.type.__asyncLoader,Vn=e=>e.type.__isKeepAlive,Hn={name:`KeepAlive`,__isKeepAlive:!0,props:{include:[String,RegExp,Array],exclude:[String,RegExp,Array],max:[String,Number]},setup(e,{slots:t}){let n=aa(),r=n.ctx;if(!r.renderer)return()=>{let e=t.default&&t.default();return e&&e.length===1?e[0]:e};let i=new Map,a=new Set,o=null,s=n.suspense,{renderer:{p:c,m:l,um:u,o:{createElement:d}}}=r,f=d(`div`);r.activate=(e,t,n,r,i)=>{let a=e.component;l(e,t,n,0,s),c(a.vnode,e,t,n,a,s,r,e.slotScopeIds,i),L(()=>{a.isDeactivated=!1,a.a&&ue(a.a);let t=e.props&&e.props.onVnodeMounted;t&&ta(t,a.parent,e)},s)},r.deactivate=e=>{let t=e.component;Ai(t.m),Ai(t.a),l(e,f,null,1,s),L(()=>{t.da&&ue(t.da);let n=e.props&&e.props.onVnodeUnmounted;n&&ta(n,t.parent,e),t.isDeactivated=!0},s)};function p(e){Jn(e),u(e,n,s,!0)}function m(e){i.forEach((t,n)=>{let r=xa(t.type);r&&!e(r)&&h(n)})}function h(e){let t=i.get(e);t&&(!o||!Wi(t,o))?p(t):o&&Jn(o),i.delete(e),a.delete(e)}Ur(()=>[e.include,e.exclude],([e,t])=>{e&&m(t=>Un(e,t)),t&&m(e=>!Un(t,e))},{flush:`post`,deep:!0});let g=null,_=()=>{g!=null&&(ji(n.subTree.type)?L(()=>{i.set(g,Yn(n.subTree))},n.subTree.suspense):i.set(g,Yn(n.subTree)))};return $n(_),tr(_),nr(()=>{i.forEach(e=>{let{subTree:t,suspense:r}=n,i=Yn(t);if(e.type===i.type&&e.key===i.key){Jn(i);let e=i.component.da;e&&L(e,r);return}p(e)})}),()=>{if(g=null,!t.default)return o=null;let n=t.default(),r=n[0];if(n.length>1)return o=null,n;if(!Ui(r)||!(r.shapeFlag&4)&&!(r.shapeFlag&128))return o=null,r;let s=Yn(r);if(s.type===Pi)return o=null,s;let c=s.type,l=xa(Bn(s)?s.type.__asyncResolved||{}:c),{include:u,exclude:d,max:f}=e;if(u&&(!l||!Un(u,l))||d&&l&&Un(d,l))return s.shapeFlag&=-257,o=s,r;let p=s.key==null?c:s.key,m=i.get(p);return s.el&&(s=Yi(s),r.shapeFlag&128&&(r.ssContent=s)),g=p,m?(s.el=m.el,s.component=m.component,s.transition&&Pn(s,s.transition),s.shapeFlag|=512,a.delete(p),a.add(p)):(a.add(p),f&&a.size>parseInt(f,10)&&h(a.values().next().value)),s.shapeFlag|=256,o=s,ji(r.type)?r:s}}};function Un(e,t){return d(e)?e.some(e=>Un(e,t)):g(e)?e.split(`,`).includes(t):m(e)?(e.lastIndex=0,e.test(t)):!1}function Wn(e,t){Kn(e,`a`,t)}function Gn(e,t){Kn(e,`da`,t)}function Kn(e,t,n=G){let r=e.__wdc||=()=>{let t=n;for(;t;){if(t.isDeactivated)return;t=t.parent}return e()};if(Xn(t,r,n),n){let e=n.parent;for(;e&&e.parent;)Vn(e.parent.vnode)&&qn(r,t,n,e),e=e.parent}}function qn(e,t,n,r){let i=Xn(t,e,r,!0);rr(()=>{c(r[t],i)},n)}function Jn(e){e.shapeFlag&=-257,e.shapeFlag&=-513}function Yn(e){return e.shapeFlag&128?e.ssContent:e}function Xn(e,t,n=G,r=!1){if(n){let i=n[e]||(n[e]=[]),a=t.__weh||=(...r)=>{Ue();let i=ca(n),a=cn(t,n,e,r);return i(),We(),a};return r?i.unshift(a):i.push(a),a}}var Zn=e=>(t,n=G)=>{(!da||e===`sp`)&&Xn(e,(...e)=>t(...e),n)},Qn=Zn(`bm`),$n=Zn(`m`),er=Zn(`bu`),tr=Zn(`u`),nr=Zn(`bum`),rr=Zn(`um`),ir=Zn(`sp`),ar=Zn(`rtg`),or=Zn(`rtc`);function sr(e,t=G){Xn(`ec`,e,t)}var cr=`components`,lr=Symbol.for(`v-ndc`);function ur(e){return g(e)?dr(cr,e,!1)||e:e||lr}function dr(e,t,n=!0,r=!1){let i=P||G;if(i){let n=i.type;if(e===cr){let e=xa(n,!1);if(e&&(e===t||e===C(t)||e===se(C(t))))return n}let a=fr(i[e]||n[e],t)||fr(i.appContext[e],t);return!a&&r?n:a}}function fr(e,t){return e&&(e[t]||e[C(t)]||e[se(C(t))])}function F(e,t,n,r){let i,a=n&&n[r],o=d(e);if(o||g(e)){let n=o&&zt(e),r=!1,s=!1;n&&(r=!Vt(e),s=Bt(e),e=nt(e)),i=Array(e.length);for(let n=0,o=e.length;n<o;n++)i[n]=t(r?s?Gt(Wt(e[n])):Wt(e[n]):e[n],n,void 0,a&&a[n])}else if(typeof e==`number`){i=Array(e);for(let n=0;n<e;n++)i[n]=t(n+1,n,void 0,a&&a[n])}else if(v(e))if(e[Symbol.iterator])i=Array.from(e,(e,n)=>t(e,n,void 0,a&&a[n]));else{let n=Object.keys(e);i=Array(n.length);for(let r=0,o=n.length;r<o;r++){let o=n[r];i[r]=t(e[o],o,r,a&&a[r])}}else i=[];return n&&(n[r]=i),i}function pr(e,t){for(let n=0;n<t.length;n++){let r=t[n];if(d(r))for(let t=0;t<r.length;t++)e[r[t].name]=r[t].fn;else r&&(e[r.name]=r.key?(...e)=>{let t=r.fn(...e);return t&&(t.key=r.key),t}:r.fn)}return e}function mr(e,t,n={},r,i){if(P.ce||P.parent&&Bn(P.parent)&&P.parent.ce){let e=Object.keys(n).length>0;return t!==`default`&&(n.name=t),z(),Hi(R,null,[H(`slot`,n,r&&r())],e?-2:64)}let a=e[t];a&&a._c&&(a._d=!1),z();let o=a&&hr(a(n)),s=n.key||o&&o.key,c=Hi(R,{key:(s&&!_(s)?s:`_${t}`)+(!o&&r?`_fb`:``)},o||(r?r():[]),o&&e._===1?64:-2);return!i&&c.scopeId&&(c.slotScopeIds=[c.scopeId+`-s`]),a&&a._c&&(a._d=!0),c}function hr(e){return e.some(e=>Ui(e)?!(e.type===Pi||e.type===R&&!hr(e.children)):!0)?e:null}var gr=e=>e?ua(e)?ba(e):gr(e.parent):null,_r=s(Object.create(null),{$:e=>e,$el:e=>e.vnode.el,$data:e=>e.data,$props:e=>e.props,$attrs:e=>e.attrs,$slots:e=>e.slots,$refs:e=>e.refs,$parent:e=>gr(e.parent),$root:e=>gr(e.root),$host:e=>e.ce,$emit:e=>e.emit,$options:e=>Er(e),$forceUpdate:e=>e.f||=()=>{yn(e.update)},$nextTick:e=>e.n||=_n.bind(e.proxy),$watch:e=>Gr.bind(e)}),vr=(e,n)=>e!==t&&!e.__isScriptSetup&&u(e,n),yr={get({_:e},n){if(n===`__v_skip`)return!0;let{ctx:r,setupState:i,data:a,props:o,accessCache:s,type:c,appContext:l}=e;if(n[0]!==`$`){let e=s[n];if(e!==void 0)switch(e){case 1:return i[n];case 2:return a[n];case 4:return r[n];case 3:return o[n]}else if(vr(i,n))return s[n]=1,i[n];else if(a!==t&&u(a,n))return s[n]=2,a[n];else if(u(o,n))return s[n]=3,o[n];else if(r!==t&&u(r,n))return s[n]=4,r[n];else xr&&(s[n]=0)}let d=_r[n],f,p;if(d)return n===`$attrs`&&k(e.attrs,`get`,``),d(e);if((f=c.__cssModules)&&(f=f[n]))return f;if(r!==t&&u(r,n))return s[n]=4,r[n];if(p=l.config.globalProperties,u(p,n))return p[n]},set({_:e},n,r){let{data:i,setupState:a,ctx:o}=e;return vr(a,n)?(a[n]=r,!0):i!==t&&u(i,n)?(i[n]=r,!0):u(e.props,n)||n[0]===`$`&&n.slice(1)in e?!1:(o[n]=r,!0)},has({_:{data:e,setupState:n,accessCache:r,ctx:i,appContext:a,props:o,type:s}},c){let l;return!!(r[c]||e!==t&&c[0]!==`$`&&u(e,c)||vr(n,c)||u(o,c)||u(i,c)||u(_r,c)||u(a.config.globalProperties,c)||(l=s.__cssModules)&&l[c])},defineProperty(e,t,n){return n.get==null?u(n,`value`)&&this.set(e,t,n.value,null):e._.accessCache[t]=0,Reflect.defineProperty(e,t,n)}};function br(e){return d(e)?e.reduce((e,t)=>(e[t]=null,e),{}):e}var xr=!0;function Sr(e){let t=Er(e),n=e.proxy,i=e.ctx;xr=!1,t.beforeCreate&&wr(t.beforeCreate,e,`bc`);let{data:a,computed:o,methods:s,watch:c,provide:l,inject:u,created:f,beforeMount:p,mounted:m,beforeUpdate:g,updated:_,activated:y,deactivated:b,beforeDestroy:x,beforeUnmount:ee,destroyed:S,unmounted:te,render:ne,renderTracked:re,renderTriggered:ie,errorCaptured:C,serverPrefetch:ae,expose:oe,inheritAttrs:se,components:ce,directives:le,filters:ue}=t;if(u&&Cr(u,i,null),s)for(let e in s){let t=s[e];h(t)&&(i[e]=t.bind(n))}if(a){let t=a.call(n,n);v(t)&&(e.data=Ft(t))}if(xr=!0,o)for(let e in o){let t=o[e],a=K({get:h(t)?t.bind(n,n):h(t.get)?t.get.bind(n,n):r,set:!h(t)&&h(t.set)?t.set.bind(n):r});Object.defineProperty(i,e,{enumerable:!0,configurable:!0,get:()=>a.value,set:e=>a.value=e})}if(c)for(let e in c)Tr(c[e],i,n,e);if(l){let e=h(l)?l.call(n):l;Reflect.ownKeys(e).forEach(t=>{zr(t,e[t])})}f&&wr(f,e,`c`);function w(e,t){d(t)?t.forEach(t=>e(t.bind(n))):t&&e(t.bind(n))}if(w(Qn,p),w($n,m),w(er,g),w(tr,_),w(Wn,y),w(Gn,b),w(sr,C),w(or,re),w(ar,ie),w(nr,ee),w(rr,te),w(ir,ae),d(oe))if(oe.length){let t=e.exposed||={};oe.forEach(e=>{Object.defineProperty(t,e,{get:()=>n[e],set:t=>n[e]=t,enumerable:!0})})}else e.exposed||={};ne&&e.render===r&&(e.render=ne),se!=null&&(e.inheritAttrs=se),ce&&(e.components=ce),le&&(e.directives=le),ae&&In(e)}function Cr(e,t,n=r){for(let n in d(e)&&(e=jr(e)),e){let r=e[n],i;i=v(r)?`default`in r?Br(r.from||n,r.default,!0):Br(r.from||n):Br(r),j(i)?Object.defineProperty(t,n,{enumerable:!0,configurable:!0,get:()=>i.value,set:e=>i.value=e}):t[n]=i}}function wr(e,t,n){cn(d(e)?e.map(e=>e.bind(t.proxy)):e.bind(t.proxy),t,n)}function Tr(e,t,n,r){let i=r.includes(`.`)?Kr(n,r):()=>n[r];if(g(e)){let n=t[e];h(n)&&Ur(i,n)}else if(h(e))Ur(i,e.bind(n));else if(v(e))if(d(e))e.forEach(e=>Tr(e,t,n,r));else{let r=h(e.handler)?e.handler.bind(n):t[e.handler];h(r)&&Ur(i,r,e)}}function Er(e){let t=e.type,{mixins:n,extends:r}=t,{mixins:i,optionsCache:a,config:{optionMergeStrategies:o}}=e.appContext,s=a.get(t),c;return s?c=s:!i.length&&!n&&!r?c=t:(c={},i.length&&i.forEach(e=>Dr(c,e,o,!0)),Dr(c,t,o)),v(t)&&a.set(t,c),c}function Dr(e,t,n,r=!1){let{mixins:i,extends:a}=t;for(let o in a&&Dr(e,a,n,!0),i&&i.forEach(t=>Dr(e,t,n,!0)),t)if(!(r&&o===`expose`)){let r=Or[o]||n&&n[o];e[o]=r?r(e[o],t[o]):t[o]}return e}var Or={data:kr,props:Nr,emits:Nr,methods:Mr,computed:Mr,beforeCreate:I,created:I,beforeMount:I,mounted:I,beforeUpdate:I,updated:I,beforeDestroy:I,beforeUnmount:I,destroyed:I,unmounted:I,activated:I,deactivated:I,errorCaptured:I,serverPrefetch:I,components:Mr,directives:Mr,watch:Pr,provide:kr,inject:Ar};function kr(e,t){return t?e?function(){return s(h(e)?e.call(this,this):e,h(t)?t.call(this,this):t)}:t:e}function Ar(e,t){return Mr(jr(e),jr(t))}function jr(e){if(d(e)){let t={};for(let n=0;n<e.length;n++)t[e[n]]=e[n];return t}return e}function I(e,t){return e?[...new Set([].concat(e,t))]:t}function Mr(e,t){return e?s(Object.create(null),e,t):t}function Nr(e,t){return e?d(e)&&d(t)?[...new Set([...e,...t])]:s(Object.create(null),br(e),br(t??{})):t}function Pr(e,t){if(!e)return t;if(!t)return e;let n=s(Object.create(null),e);for(let r in t)n[r]=I(e[r],t[r]);return n}function Fr(){return{app:null,config:{isNativeTag:i,performance:!1,globalProperties:{},optionMergeStrategies:{},errorHandler:void 0,warnHandler:void 0,compilerOptions:{}},mixins:[],components:{},directives:{},provides:Object.create(null),optionsCache:new WeakMap,propsCache:new WeakMap,emitsCache:new WeakMap}}var Ir=0;function Lr(e,t){return function(n,r=null){h(n)||(n=s({},n)),r!=null&&!v(r)&&(r=null);let i=Fr(),a=new WeakSet,o=[],c=!1,l=i.app={_uid:Ir++,_component:n,_props:r,_container:null,_context:i,_instance:null,version:wa,get config(){return i.config},set config(e){},use(e,...t){return a.has(e)||(e&&h(e.install)?(a.add(e),e.install(l,...t)):h(e)&&(a.add(e),e(l,...t))),l},mixin(e){return i.mixins.includes(e)||i.mixins.push(e),l},component(e,t){return t?(i.components[e]=t,l):i.components[e]},directive(e,t){return t?(i.directives[e]=t,l):i.directives[e]},mount(a,o,s){if(!c){let u=l._ceVNode||H(n,r);return u.appContext=i,s===!0?s=`svg`:s===!1&&(s=void 0),o&&t?t(u,a):e(u,a,s),c=!0,l._container=a,a.__vue_app__=l,ba(u.component)}},onUnmount(e){o.push(e)},unmount(){c&&(cn(o,l._instance,16),e(null,l._container),delete l._container.__vue_app__)},provide(e,t){return i.provides[e]=t,l},runWithContext(e){let t=Rr;Rr=l;try{return e()}finally{Rr=t}}};return l}}var Rr=null;function zr(e,t){if(G){let n=G.provides,r=G.parent&&G.parent.provides;r===n&&(n=G.provides=Object.create(r)),n[e]=t}}function Br(e,t,n=!1){let r=aa();if(r||Rr){let i=Rr?Rr._context.provides:r?r.parent==null||r.ce?r.vnode.appContext&&r.vnode.appContext.provides:r.parent.provides:void 0;if(i&&e in i)return i[e];if(arguments.length>1)return n&&h(t)?t.call(r&&r.proxy):t}}var Vr=Symbol.for(`v-scx`),Hr=()=>Br(Vr);function Ur(e,t,n){return Wr(e,t,n)}function Wr(e,n,i=t){let{immediate:a,deep:o,flush:c,once:l}=i,u=s({},i),d=n&&a||!n&&c!==`post`,f;if(da){if(c===`sync`){let e=Hr();f=e.__watcherHandles||=[]}else if(!d){let e=()=>{};return e.stop=r,e.resume=r,e.pause=r,e}}let p=G;u.call=(e,t,n)=>cn(e,p,t,n);let m=!1;c===`post`?u.scheduler=e=>{L(e,p&&p.suspense)}:c!==`sync`&&(m=!0,u.scheduler=(e,t)=>{t?e():yn(e)}),u.augmentJob=e=>{n&&(e.flags|=4),m&&(e.flags|=2,p&&(e.id=p.uid,e.i=p))};let h=an(e,n,u);return da&&(f?f.push(h):d&&h()),h}function Gr(e,t,n){let r=this.proxy,i=g(e)?e.includes(`.`)?Kr(r,e):()=>r[e]:e.bind(r,r),a;h(t)?a=t:(a=t.handler,n=t);let o=ca(this),s=Wr(i,a.bind(r),n);return o(),s}function Kr(e,t){let n=t.split(`.`);return()=>{let t=e;for(let e=0;e<n.length&&t;e++)t=t[n[e]];return t}}var qr=(e,t)=>t===`modelValue`||t===`model-value`?e.modelModifiers:e[`${t}Modifiers`]||e[`${C(t)}Modifiers`]||e[`${oe(t)}Modifiers`];function Jr(e,n,...r){if(e.isUnmounted)return;let i=e.vnode.props||t,a=r,o=n.startsWith(`update:`),s=o&&qr(i,n.slice(7));s&&(s.trim&&(a=r.map(e=>g(e)?e.trim():e)),s.number&&(a=r.map(de)));let c,l=i[c=ce(n)]||i[c=ce(C(n))];!l&&o&&(l=i[c=ce(oe(n))]),l&&cn(l,e,6,a);let u=i[c+`Once`];if(u){if(!e.emitted)e.emitted={};else if(e.emitted[c])return;e.emitted[c]=!0,cn(u,e,6,a)}}var Yr=new WeakMap;function Xr(e,t,n=!1){let r=n?Yr:t.emitsCache,i=r.get(e);if(i!==void 0)return i;let a=e.emits,o={},c=!1;if(!h(e)){let r=e=>{let n=Xr(e,t,!0);n&&(c=!0,s(o,n))};!n&&t.mixins.length&&t.mixins.forEach(r),e.extends&&r(e.extends),e.mixins&&e.mixins.forEach(r)}return!a&&!c?(v(e)&&r.set(e,null),null):(d(a)?a.forEach(e=>o[e]=null):s(o,a),v(e)&&r.set(e,o),o)}function Zr(e,t){return!e||!a(t)?!1:(t=t.slice(2).replace(/Once$/,``),u(e,t[0].toLowerCase()+t.slice(1))||u(e,oe(t))||u(e,t))}function Qr(e){let{type:t,vnode:n,proxy:r,withProxy:i,propsOptions:[a],slots:s,attrs:c,emit:l,render:u,renderCache:d,props:f,data:p,setupState:m,ctx:h,inheritAttrs:g}=e,_=Dn(e),v,y;try{if(n.shapeFlag&4){let e=i||r,t=e;v=Zi(u.call(t,e,d,f,m,p,h)),y=c}else{let e=t;v=Zi(e.length>1?e(f,{attrs:c,slots:s,emit:l}):e(f,null)),y=t.props?c:$r(c)}}catch(t){Ii.length=0,ln(t,e,1),v=H(Pi)}let b=v;if(y&&g!==!1){let e=Object.keys(y),{shapeFlag:t}=b;e.length&&t&7&&(a&&e.some(o)&&(y=ei(y,a)),b=Yi(b,y,!1,!0))}return n.dirs&&(b=Yi(b,null,!1,!0),b.dirs=b.dirs?b.dirs.concat(n.dirs):n.dirs),n.transition&&Pn(b,n.transition),v=b,Dn(_),v}var $r=e=>{let t;for(let n in e)(n===`class`||n===`style`||a(n))&&((t||={})[n]=e[n]);return t},ei=(e,t)=>{let n={};for(let r in e)(!o(r)||!(r.slice(9)in t))&&(n[r]=e[r]);return n};function ti(e,t,n){let{props:r,children:i,component:a}=e,{props:o,children:s,patchFlag:c}=t,l=a.emitsOptions;if(t.dirs||t.transition)return!0;if(n&&c>=0){if(c&1024)return!0;if(c&16)return r?ni(r,o,l):!!o;if(c&8){let e=t.dynamicProps;for(let t=0;t<e.length;t++){let n=e[t];if(o[n]!==r[n]&&!Zr(l,n))return!0}}}else return(i||s)&&(!s||!s.$stable)?!0:r===o?!1:r?o?ni(r,o,l):!0:!!o;return!1}function ni(e,t,n){let r=Object.keys(t);if(r.length!==Object.keys(e).length)return!0;for(let i=0;i<r.length;i++){let a=r[i];if(t[a]!==e[a]&&!Zr(n,a))return!0}return!1}function ri({vnode:e,parent:t},n){for(;t;){let r=t.subTree;if(r.suspense&&r.suspense.activeBranch===e&&(r.el=e.el),r===e)(e=t.vnode).el=n,t=t.parent;else break}}var ii={},ai=()=>Object.create(ii),oi=e=>Object.getPrototypeOf(e)===ii;function si(e,t,n,r=!1){let i={},a=ai();for(let n in e.propsDefaults=Object.create(null),li(e,t,i,a),e.propsOptions[0])n in i||(i[n]=void 0);n?e.props=r?i:It(i):e.type.props?e.props=i:e.props=a,e.attrs=a}function ci(e,t,n,r){let{props:i,attrs:a,vnode:{patchFlag:o}}=e,s=A(i),[c]=e.propsOptions,l=!1;if((r||o>0)&&!(o&16)){if(o&8){let n=e.vnode.dynamicProps;for(let r=0;r<n.length;r++){let o=n[r];if(Zr(e.emitsOptions,o))continue;let d=t[o];if(c)if(u(a,o))d!==a[o]&&(a[o]=d,l=!0);else{let t=C(o);i[t]=ui(c,s,t,d,e,!1)}else d!==a[o]&&(a[o]=d,l=!0)}}}else{li(e,t,i,a)&&(l=!0);let r;for(let a in s)(!t||!u(t,a)&&((r=oe(a))===a||!u(t,r)))&&(c?n&&(n[a]!==void 0||n[r]!==void 0)&&(i[a]=ui(c,s,a,void 0,e,!0)):delete i[a]);if(a!==s)for(let e in a)(!t||!u(t,e))&&(delete a[e],l=!0)}l&&et(e.attrs,`set`,``)}function li(e,n,r,i){let[a,o]=e.propsOptions,s=!1,c;if(n)for(let t in n){if(ne(t))continue;let l=n[t],d;a&&u(a,d=C(t))?!o||!o.includes(d)?r[d]=l:(c||={})[d]=l:Zr(e.emitsOptions,t)||(!(t in i)||l!==i[t])&&(i[t]=l,s=!0)}if(o){let n=A(r),i=c||t;for(let t=0;t<o.length;t++){let s=o[t];r[s]=ui(a,n,s,i[s],e,!u(i,s))}}return s}function ui(e,t,n,r,i,a){let o=e[n];if(o!=null){let e=u(o,`default`);if(e&&r===void 0){let e=o.default;if(o.type!==Function&&!o.skipFactory&&h(e)){let{propsDefaults:a}=i;if(n in a)r=a[n];else{let o=ca(i);r=a[n]=e.call(null,t),o()}}else r=e;i.ce&&i.ce._setProp(n,r)}o[0]&&(a&&!e?r=!1:o[1]&&(r===``||r===oe(n))&&(r=!0))}return r}var di=new WeakMap;function fi(e,r,i=!1){let a=i?di:r.propsCache,o=a.get(e);if(o)return o;let c=e.props,l={},f=[],p=!1;if(!h(e)){let t=e=>{p=!0;let[t,n]=fi(e,r,!0);s(l,t),n&&f.push(...n)};!i&&r.mixins.length&&r.mixins.forEach(t),e.extends&&t(e.extends),e.mixins&&e.mixins.forEach(t)}if(!c&&!p)return v(e)&&a.set(e,n),n;if(d(c))for(let e=0;e<c.length;e++){let n=C(c[e]);pi(n)&&(l[n]=t)}else if(c)for(let e in c){let t=C(e);if(pi(t)){let n=c[e],r=l[t]=d(n)||h(n)?{type:n}:s({},n),i=r.type,a=!1,o=!0;if(d(i))for(let e=0;e<i.length;++e){let t=i[e],n=h(t)&&t.name;if(n===`Boolean`){a=!0;break}else n===`String`&&(o=!1)}else a=h(i)&&i.name===`Boolean`;r[0]=a,r[1]=o,(a||u(r,`default`))&&f.push(t)}}let m=[l,f];return v(e)&&a.set(e,m),m}function pi(e){return e[0]!==`$`&&!ne(e)}var mi=e=>e===`_`||e===`_ctx`||e===`$stable`,hi=e=>d(e)?e.map(Zi):[Zi(e)],gi=(e,t,n)=>{if(t._n)return t;let r=On((...e)=>hi(t(...e)),n);return r._c=!1,r},_i=(e,t,n)=>{let r=e._ctx;for(let n in e){if(mi(n))continue;let i=e[n];if(h(i))t[n]=gi(n,i,r);else if(i!=null){let e=hi(i);t[n]=()=>e}}},vi=(e,t)=>{let n=hi(t);e.slots.default=()=>n},yi=(e,t,n)=>{for(let r in t)(n||!mi(r))&&(e[r]=t[r])},bi=(e,t,n)=>{let r=e.slots=ai();if(e.vnode.shapeFlag&32){let e=t._;e?(yi(r,t,n),n&&w(r,`_`,e,!0)):_i(t,r)}else t&&vi(e,t)},xi=(e,n,r)=>{let{vnode:i,slots:a}=e,o=!0,s=t;if(i.shapeFlag&32){let e=n._;e?r&&e===1?o=!1:yi(a,n,r):(o=!n.$stable,_i(n,a)),s=n}else n&&(vi(e,n),s={default:1});if(o)for(let e in a)!mi(e)&&s[e]==null&&delete a[e]},L=Mi;function Si(e){return Ci(e)}function Ci(e,i){let a=pe();a.__VUE__=!0;let{insert:o,remove:s,patchProp:c,createElement:l,createText:u,createComment:d,setText:f,setElementText:p,parentNode:m,nextSibling:h,setScopeId:g=r,insertStaticContent:_}=e,v=(e,t,n,r=null,i=null,a=null,o=void 0,s=null,c=!!t.dynamicChildren)=>{if(e===t)return;e&&!Wi(e,t)&&(r=E(e),ve(e,i,a,!0),e=null),t.patchFlag===-2&&(c=!1,t.dynamicChildren=null);let{type:l,ref:u,shapeFlag:d}=t;switch(l){case Ni:y(e,t,n,r);break;case Pi:b(e,t,n,r);break;case Fi:e??x(t,n,r,o);break;case R:ce(e,t,n,r,i,a,o,s,c);break;default:d&1?te(e,t,n,r,i,a,o,s,c):d&6?le(e,t,n,r,i,a,o,s,c):(d&64||d&128)&&l.process(e,t,n,r,i,a,o,s,c,D)}u!=null&&i?Rn(u,e&&e.ref,a,t||e,!t):u==null&&e&&e.ref!=null&&Rn(e.ref,null,a,e,!0)},y=(e,t,n,r)=>{if(e==null)o(t.el=u(t.children),n,r);else{let n=t.el=e.el;t.children!==e.children&&f(n,t.children)}},b=(e,t,n,r)=>{e==null?o(t.el=d(t.children||``),n,r):t.el=e.el},x=(e,t,n,r)=>{[e.el,e.anchor]=_(e.children,t,n,r,e.el,e.anchor)},ee=({el:e,anchor:t},n,r)=>{let i;for(;e&&e!==t;)i=h(e),o(e,n,r),e=i;o(t,n,r)},S=({el:e,anchor:t})=>{let n;for(;e&&e!==t;)n=h(e),s(e),e=n;s(t)},te=(e,t,n,r,i,a,o,s,c)=>{if(t.type===`svg`?o=`svg`:t.type===`math`&&(o=`mathml`),e==null)re(t,n,r,i,a,o,s,c);else{let n=e.el&&e.el._isVueCE?e.el:null;try{n&&n._beginPatch(),ae(e,t,i,a,o,s,c)}finally{n&&n._endPatch()}}},re=(e,t,n,r,i,a,s,u)=>{let d,f,{props:m,shapeFlag:h,transition:g,dirs:_}=e;if(d=e.el=l(e.type,a,m&&m.is,m),h&8?p(d,e.children):h&16&&C(e.children,d,null,r,i,wi(e,a),s,u),_&&An(e,null,r,`created`),ie(d,e,e.scopeId,s,r),m){for(let e in m)e!==`value`&&!ne(e)&&c(d,e,null,m[e],a,r);`value`in m&&c(d,`value`,null,m.value,a),(f=m.onVnodeBeforeMount)&&ta(f,r,e)}_&&An(e,null,r,`beforeMount`);let v=Ei(i,g);v&&g.beforeEnter(d),o(d,t,n),((f=m&&m.onVnodeMounted)||v||_)&&L(()=>{f&&ta(f,r,e),v&&g.enter(d),_&&An(e,null,r,`mounted`)},i)},ie=(e,t,n,r,i)=>{if(n&&g(e,n),r)for(let t=0;t<r.length;t++)g(e,r[t]);if(i){let n=i.subTree;if(t===n||ji(n.type)&&(n.ssContent===t||n.ssFallback===t)){let t=i.vnode;ie(e,t,t.scopeId,t.slotScopeIds,i.parent)}}},C=(e,t,n,r,i,a,o,s,c=0)=>{for(let l=c;l<e.length;l++)v(null,e[l]=s?Qi(e[l]):Zi(e[l]),t,n,r,i,a,o,s)},ae=(e,n,r,i,a,o,s)=>{let l=n.el=e.el,{patchFlag:u,dynamicChildren:d,dirs:f}=n;u|=e.patchFlag&16;let m=e.props||t,h=n.props||t,g;if(r&&Ti(r,!1),(g=h.onVnodeBeforeUpdate)&&ta(g,r,n,e),f&&An(n,e,r,`beforeUpdate`),r&&Ti(r,!0),(m.innerHTML&&h.innerHTML==null||m.textContent&&h.textContent==null)&&p(l,``),d?oe(e.dynamicChildren,d,l,r,i,wi(n,a),o):s||me(e,n,l,null,r,i,wi(n,a),o,!1),u>0){if(u&16)se(l,m,h,r,a);else if(u&2&&m.class!==h.class&&c(l,`class`,null,h.class,a),u&4&&c(l,`style`,m.style,h.style,a),u&8){let e=n.dynamicProps;for(let t=0;t<e.length;t++){let n=e[t],i=m[n],o=h[n];(o!==i||n===`value`)&&c(l,n,i,o,a,r)}}u&1&&e.children!==n.children&&p(l,n.children)}else !s&&d==null&&se(l,m,h,r,a);((g=h.onVnodeUpdated)||f)&&L(()=>{g&&ta(g,r,n,e),f&&An(n,e,r,`updated`)},i)},oe=(e,t,n,r,i,a,o)=>{for(let s=0;s<t.length;s++){let c=e[s],l=t[s];v(c,l,c.el&&(c.type===R||!Wi(c,l)||c.shapeFlag&198)?m(c.el):n,null,r,i,a,o,!0)}},se=(e,n,r,i,a)=>{if(n!==r){if(n!==t)for(let t in n)!ne(t)&&!(t in r)&&c(e,t,n[t],null,a,i);for(let t in r){if(ne(t))continue;let o=r[t],s=n[t];o!==s&&t!==`value`&&c(e,t,s,o,a,i)}`value`in r&&c(e,`value`,n.value,r.value,a)}},ce=(e,t,n,r,i,a,s,c,l)=>{let d=t.el=e?e.el:u(``),f=t.anchor=e?e.anchor:u(``),{patchFlag:p,dynamicChildren:m,slotScopeIds:h}=t;h&&(c=c?c.concat(h):h),e==null?(o(d,n,r),o(f,n,r),C(t.children||[],n,f,i,a,s,c,l)):p>0&&p&64&&m&&e.dynamicChildren?(oe(e.dynamicChildren,m,n,i,a,s,c),(t.key!=null||i&&t===i.subTree)&&Di(e,t,!0)):me(e,t,n,f,i,a,s,c,l)},le=(e,t,n,r,i,a,o,s,c)=>{t.slotScopeIds=s,e==null?t.shapeFlag&512?i.ctx.activate(t,n,r,o,c):w(t,n,r,i,a,o,c):de(e,t,c)},w=(e,t,n,r,i,a,o)=>{let s=e.component=ia(e,r,i);if(Vn(e)&&(s.ctx.renderer=D),fa(s,!1,o),s.asyncDep){if(i&&i.registerDep(s,fe,o),!e.el){let r=s.subTree=H(Pi);b(null,r,t,n),e.placeholder=r.el}}else fe(s,e,t,n,i,a,o)},de=(e,t,n)=>{let r=t.component=e.component;if(ti(e,t,n))if(r.asyncDep&&!r.asyncResolved){T(r,t,n);return}else r.next=t,r.update();else t.el=e.el,r.vnode=t},fe=(e,t,n,r,i,a,o)=>{let s=()=>{if(e.isMounted){let{next:t,bu:n,u:r,parent:c,vnode:l}=e;{let n=ki(e);if(n){t&&(t.el=l.el,T(e,t,o)),n.asyncDep.then(()=>{e.isUnmounted||s()});return}}let u=t,d;Ti(e,!1),t?(t.el=l.el,T(e,t,o)):t=l,n&&ue(n),(d=t.props&&t.props.onVnodeBeforeUpdate)&&ta(d,c,t,l),Ti(e,!0);let f=Qr(e),p=e.subTree;e.subTree=f,v(p,f,m(p.el),E(p),e,i,a),t.el=f.el,u===null&&ri(e,f.el),r&&L(r,i),(d=t.props&&t.props.onVnodeUpdated)&&L(()=>ta(d,c,t,l),i)}else{let o,{el:s,props:c}=t,{bm:l,m:u,parent:d,root:f,type:p}=e,m=Bn(t);if(Ti(e,!1),l&&ue(l),!m&&(o=c&&c.onVnodeBeforeMount)&&ta(o,d,t),Ti(e,!0),s&&Ee){let t=()=>{e.subTree=Qr(e),Ee(s,e.subTree,e,i,null)};m&&p.__asyncHydrate?p.__asyncHydrate(s,e,t):t()}else{f.ce&&f.ce._def.shadowRoot!==!1&&f.ce._injectChildStyle(p);let o=e.subTree=Qr(e);v(null,o,n,r,e,i,a),t.el=o.el}if(u&&L(u,i),!m&&(o=c&&c.onVnodeMounted)){let e=t;L(()=>ta(o,d,e),i)}(t.shapeFlag&256||d&&Bn(d.vnode)&&d.vnode.shapeFlag&256)&&e.a&&L(e.a,i),e.isMounted=!0,t=n=r=null}};e.scope.on();let c=e.effect=new Oe(s);e.scope.off();let l=e.update=c.run.bind(c),u=e.job=c.runIfDirty.bind(c);u.i=e,u.id=e.uid,c.scheduler=()=>yn(u),Ti(e,!0),l()},T=(e,t,n)=>{t.component=e;let r=e.vnode.props;e.vnode=t,e.next=null,ci(e,t.props,r,n),xi(e,t.children,n),Ue(),Sn(e),We()},me=(e,t,n,r,i,a,o,s,c=!1)=>{let l=e&&e.children,u=e?e.shapeFlag:0,d=t.children,{patchFlag:f,shapeFlag:m}=t;if(f>0){if(f&128){ge(l,d,n,r,i,a,o,s,c);return}else if(f&256){he(l,d,n,r,i,a,o,s,c);return}}m&8?(u&16&&Se(l,i,a),d!==l&&p(n,d)):u&16?m&16?ge(l,d,n,r,i,a,o,s,c):Se(l,i,a,!0):(u&8&&p(n,``),m&16&&C(d,n,r,i,a,o,s,c))},he=(e,t,r,i,a,o,s,c,l)=>{e||=n,t||=n;let u=e.length,d=t.length,f=Math.min(u,d),p;for(p=0;p<f;p++){let n=t[p]=l?Qi(t[p]):Zi(t[p]);v(e[p],n,r,null,a,o,s,c,l)}u>d?Se(e,a,o,!0,!1,f):C(t,r,i,a,o,s,c,l,f)},ge=(e,t,r,i,a,o,s,c,l)=>{let u=0,d=t.length,f=e.length-1,p=d-1;for(;u<=f&&u<=p;){let n=e[u],i=t[u]=l?Qi(t[u]):Zi(t[u]);if(Wi(n,i))v(n,i,r,null,a,o,s,c,l);else break;u++}for(;u<=f&&u<=p;){let n=e[f],i=t[p]=l?Qi(t[p]):Zi(t[p]);if(Wi(n,i))v(n,i,r,null,a,o,s,c,l);else break;f--,p--}if(u>f){if(u<=p){let e=p+1,n=e<d?t[e].el:i;for(;u<=p;)v(null,t[u]=l?Qi(t[u]):Zi(t[u]),r,n,a,o,s,c,l),u++}}else if(u>p)for(;u<=f;)ve(e[u],a,o,!0),u++;else{let m=u,h=u,g=new Map;for(u=h;u<=p;u++){let e=t[u]=l?Qi(t[u]):Zi(t[u]);e.key!=null&&g.set(e.key,u)}let _,y=0,b=p-h+1,x=!1,ee=0,S=Array(b);for(u=0;u<b;u++)S[u]=0;for(u=m;u<=f;u++){let n=e[u];if(y>=b){ve(n,a,o,!0);continue}let i;if(n.key!=null)i=g.get(n.key);else for(_=h;_<=p;_++)if(S[_-h]===0&&Wi(n,t[_])){i=_;break}i===void 0?ve(n,a,o,!0):(S[i-h]=u+1,i>=ee?ee=i:x=!0,v(n,t[i],r,null,a,o,s,c,l),y++)}let te=x?Oi(S):n;for(_=te.length-1,u=b-1;u>=0;u--){let e=h+u,n=t[e],f=t[e+1],p=e+1<d?f.el||f.placeholder:i;S[u]===0?v(null,n,r,p,a,o,s,c,l):x&&(_<0||u!==te[_]?_e(n,r,p,2):_--)}}},_e=(e,t,n,r,i=null)=>{let{el:a,type:c,transition:l,children:u,shapeFlag:d}=e;if(d&6){_e(e.component.subTree,t,n,r);return}if(d&128){e.suspense.move(t,n,r);return}if(d&64){c.move(e,t,n,D);return}if(c===R){o(a,t,n);for(let e=0;e<u.length;e++)_e(u[e],t,n,r);o(e.anchor,t,n);return}if(c===Fi){ee(e,t,n);return}if(r!==2&&d&1&&l)if(r===0)l.beforeEnter(a),o(a,t,n),L(()=>l.enter(a),i);else{let{leave:r,delayLeave:i,afterLeave:c}=l,u=()=>{e.ctx.isUnmounted?s(a):o(a,t,n)},d=()=>{a._isLeaving&&a[Nn](!0),r(a,()=>{u(),c&&c()})};i?i(a,u,d):d()}else o(a,t,n)},ve=(e,t,n,r=!1,i=!1)=>{let{type:a,props:o,ref:s,children:c,dynamicChildren:l,shapeFlag:u,patchFlag:d,dirs:f,cacheIndex:p}=e;if(d===-2&&(i=!1),s!=null&&(Ue(),Rn(s,null,n,e,!0),We()),p!=null&&(t.renderCache[p]=void 0),u&256){t.ctx.deactivate(e);return}let m=u&1&&f,h=!Bn(e),g;if(h&&(g=o&&o.onVnodeBeforeUnmount)&&ta(g,t,e),u&6)xe(e.component,n,r);else{if(u&128){e.suspense.unmount(n,r);return}m&&An(e,null,t,`beforeUnmount`),u&64?e.type.remove(e,t,n,D,r):l&&!l.hasOnce&&(a!==R||d>0&&d&64)?Se(l,t,n,!1,!0):(a===R&&d&384||!i&&u&16)&&Se(c,t,n),r&&ye(e)}(h&&(g=o&&o.onVnodeUnmounted)||m)&&L(()=>{g&&ta(g,t,e),m&&An(e,null,t,`unmounted`)},n)},ye=e=>{let{type:t,el:n,anchor:r,transition:i}=e;if(t===R){be(n,r);return}if(t===Fi){S(e);return}let a=()=>{s(n),i&&!i.persisted&&i.afterLeave&&i.afterLeave()};if(e.shapeFlag&1&&i&&!i.persisted){let{leave:t,delayLeave:r}=i,o=()=>t(n,a);r?r(e.el,a,o):o()}else a()},be=(e,t)=>{let n;for(;e!==t;)n=h(e),s(e),e=n;s(t)},xe=(e,t,n)=>{let{bum:r,scope:i,job:a,subTree:o,um:s,m:c,a:l}=e;Ai(c),Ai(l),r&&ue(r),i.stop(),a&&(a.flags|=8,ve(o,e,t,n)),s&&L(s,t),L(()=>{e.isUnmounted=!0},t)},Se=(e,t,n,r=!1,i=!1,a=0)=>{for(let o=a;o<e.length;o++)ve(e[o],t,n,r,i)},E=e=>{if(e.shapeFlag&6)return E(e.component.subTree);if(e.shapeFlag&128)return e.suspense.next();let t=h(e.anchor||e.el),n=t&&t[jn];return n?h(n):t},Ce=!1,we=(e,t,n)=>{e==null?t._vnode&&ve(t._vnode,null,null,!0):v(t._vnode||null,e,t,null,null,null,n),t._vnode=e,Ce||=(Ce=!0,Sn(),Cn(),!1)},D={p:v,um:ve,m:_e,r:ye,mt:w,mc:C,pc:me,pbc:oe,n:E,o:e},Te,Ee;return i&&([Te,Ee]=i(D)),{render:we,hydrate:Te,createApp:Lr(we,Te)}}function wi({type:e,props:t},n){return n===`svg`&&e===`foreignObject`||n===`mathml`&&e===`annotation-xml`&&t&&t.encoding&&t.encoding.includes(`html`)?void 0:n}function Ti({effect:e,job:t},n){n?(e.flags|=32,t.flags|=4):(e.flags&=-33,t.flags&=-5)}function Ei(e,t){return(!e||e&&!e.pendingBranch)&&t&&!t.persisted}function Di(e,t,n=!1){let r=e.children,i=t.children;if(d(r)&&d(i))for(let e=0;e<r.length;e++){let t=r[e],a=i[e];a.shapeFlag&1&&!a.dynamicChildren&&((a.patchFlag<=0||a.patchFlag===32)&&(a=i[e]=Qi(i[e]),a.el=t.el),!n&&a.patchFlag!==-2&&Di(t,a)),a.type===Ni&&a.patchFlag!==-1&&(a.el=t.el),a.type===Pi&&!a.el&&(a.el=t.el)}}function Oi(e){let t=e.slice(),n=[0],r,i,a,o,s,c=e.length;for(r=0;r<c;r++){let c=e[r];if(c!==0){if(i=n[n.length-1],e[i]<c){t[r]=i,n.push(r);continue}for(a=0,o=n.length-1;a<o;)s=a+o>>1,e[n[s]]<c?a=s+1:o=s;c<e[n[a]]&&(a>0&&(t[r]=n[a-1]),n[a]=r)}}for(a=n.length,o=n[a-1];a-- >0;)n[a]=o,o=t[o];return n}function ki(e){let t=e.subTree.component;if(t)return t.asyncDep&&!t.asyncResolved?t:ki(t)}function Ai(e){if(e)for(let t=0;t<e.length;t++)e[t].flags|=8}var ji=e=>e.__isSuspense;function Mi(e,t){t&&t.pendingBranch?d(e)?t.effects.push(...e):t.effects.push(e):xn(e)}var R=Symbol.for(`v-fgt`),Ni=Symbol.for(`v-txt`),Pi=Symbol.for(`v-cmt`),Fi=Symbol.for(`v-stc`),Ii=[],Li=null;function z(e=!1){Ii.push(Li=e?null:[])}function Ri(){Ii.pop(),Li=Ii[Ii.length-1]||null}var zi=1;function Bi(e,t=!1){zi+=e,e<0&&Li&&t&&(Li.hasOnce=!0)}function Vi(e){return e.dynamicChildren=zi>0?Li||n:null,Ri(),zi>0&&Li&&Li.push(e),e}function B(e,t,n,r,i,a){return Vi(V(e,t,n,r,i,a,!0))}function Hi(e,t,n,r,i){return Vi(H(e,t,n,r,i,!0))}function Ui(e){return e?e.__v_isVNode===!0:!1}function Wi(e,t){return e.type===t.type&&e.key===t.key}var Gi=({key:e})=>e??null,Ki=({ref:e,ref_key:t,ref_for:n})=>(typeof e==`number`&&(e=``+e),e==null?null:g(e)||j(e)||h(e)?{i:P,r:e,k:t,f:!!n}:e);function V(e,t=null,n=null,r=0,i=null,a=e===R?0:1,o=!1,s=!1){let c={__v_isVNode:!0,__v_skip:!0,type:e,props:t,key:t&&Gi(t),ref:t&&Ki(t),scopeId:En,slotScopeIds:null,children:n,component:null,suspense:null,ssContent:null,ssFallback:null,dirs:null,transition:null,el:null,anchor:null,target:null,targetStart:null,targetAnchor:null,staticCount:0,shapeFlag:a,patchFlag:r,dynamicProps:i,dynamicChildren:null,appContext:null,ctx:P};return s?($i(c,n),a&128&&e.normalize(c)):n&&(c.shapeFlag|=g(n)?8:16),zi>0&&!o&&Li&&(c.patchFlag>0||a&6)&&c.patchFlag!==32&&Li.push(c),c}var H=qi;function qi(e,t=null,n=null,r=0,i=null,a=!1){if((!e||e===lr)&&(e=Pi),Ui(e)){let r=Yi(e,t,!0);return n&&$i(r,n),zi>0&&!a&&Li&&(r.shapeFlag&6?Li[Li.indexOf(e)]=r:Li.push(r)),r.patchFlag=-2,r}if(Sa(e)&&(e=e.__vccOpts),t){t=Ji(t);let{class:e,style:n}=t;e&&!g(e)&&(t.class=ve(e)),v(n)&&(Ht(n)&&!d(n)&&(n=s({},n)),t.style=T(n))}let o=g(e)?1:ji(e)?128:Mn(e)?64:v(e)?4:h(e)?2:0;return V(e,t,n,r,i,o,a,!0)}function Ji(e){return e?Ht(e)||oi(e)?s({},e):e:null}function Yi(e,t,n=!1,r=!1){let{props:i,ref:a,patchFlag:o,children:s,transition:c}=e,l=t?ea(i||{},t):i,u={__v_isVNode:!0,__v_skip:!0,type:e.type,props:l,key:l&&Gi(l),ref:t&&t.ref?n&&a?d(a)?a.concat(Ki(t)):[a,Ki(t)]:Ki(t):a,scopeId:e.scopeId,slotScopeIds:e.slotScopeIds,children:s,target:e.target,targetStart:e.targetStart,targetAnchor:e.targetAnchor,staticCount:e.staticCount,shapeFlag:e.shapeFlag,patchFlag:t&&e.type!==R?o===-1?16:o|16:o,dynamicProps:e.dynamicProps,dynamicChildren:e.dynamicChildren,appContext:e.appContext,dirs:e.dirs,transition:c,component:e.component,suspense:e.suspense,ssContent:e.ssContent&&Yi(e.ssContent),ssFallback:e.ssFallback&&Yi(e.ssFallback),placeholder:e.placeholder,el:e.el,anchor:e.anchor,ctx:e.ctx,ce:e.ce};return c&&r&&Pn(u,c.clone(u)),u}function U(e=` `,t=0){return H(Ni,null,e,t)}function Xi(e,t){let n=H(Fi,null,e);return n.staticCount=t,n}function W(e=``,t=!1){return t?(z(),Hi(Pi,null,e)):H(Pi,null,e)}function Zi(e){return e==null||typeof e==`boolean`?H(Pi):d(e)?H(R,null,e.slice()):Ui(e)?Qi(e):H(Ni,null,String(e))}function Qi(e){return e.el===null&&e.patchFlag!==-1||e.memo?e:Yi(e)}function $i(e,t){let n=0,{shapeFlag:r}=e;if(t==null)t=null;else if(d(t))n=16;else if(typeof t==`object`)if(r&65){let n=t.default;n&&(n._c&&(n._d=!1),$i(e,n()),n._c&&(n._d=!0));return}else{n=32;let r=t._;!r&&!oi(t)?t._ctx=P:r===3&&P&&(P.slots._===1?t._=1:(t._=2,e.patchFlag|=1024))}else h(t)?(t={default:t,_ctx:P},n=32):(t=String(t),r&64?(n=16,t=[U(t)]):n=8);e.children=t,e.shapeFlag|=n}function ea(...e){let t={};for(let n=0;n<e.length;n++){let r=e[n];for(let e in r)if(e===`class`)t.class!==r.class&&(t.class=ve([t.class,r.class]));else if(e===`style`)t.style=T([t.style,r.style]);else if(a(e)){let n=t[e],i=r[e];i&&n!==i&&!(d(n)&&n.includes(i))&&(t[e]=n?[].concat(n,i):i)}else e!==``&&(t[e]=r[e])}return t}function ta(e,t,n,r=null){cn(e,t,7,[n,r])}var na=Fr(),ra=0;function ia(e,n,r){let i=e.type,a=(n?n.appContext:e.appContext)||na,o={uid:ra++,vnode:e,type:i,parent:n,appContext:a,root:null,next:null,subTree:null,effect:null,update:null,job:null,scope:new Te(!0),render:null,proxy:null,exposed:null,exposeProxy:null,withProxy:null,provides:n?n.provides:Object.create(a.provides),ids:n?n.ids:[``,0,0],accessCache:null,renderCache:[],components:null,directives:null,propsOptions:fi(i,a),emitsOptions:Xr(i,a),emit:null,emitted:null,propsDefaults:t,inheritAttrs:i.inheritAttrs,ctx:t,data:t,props:t,attrs:t,slots:t,refs:t,setupState:t,setupContext:null,suspense:r,suspenseId:r?r.pendingId:0,asyncDep:null,asyncResolved:!1,isMounted:!1,isUnmounted:!1,isDeactivated:!1,bc:null,c:null,bm:null,m:null,bu:null,u:null,um:null,bum:null,da:null,a:null,rtg:null,rtc:null,ec:null,sp:null};return o.ctx={_:o},o.root=n?n.root:o,o.emit=Jr.bind(null,o),e.ce&&e.ce(o),o}var G=null,aa=()=>G||P,oa,sa;{let e=pe(),t=(t,n)=>{let r;return(r=e[t])||(r=e[t]=[]),r.push(n),e=>{r.length>1?r.forEach(t=>t(e)):r[0](e)}};oa=t(`__VUE_INSTANCE_SETTERS__`,e=>G=e),sa=t(`__VUE_SSR_SETTERS__`,e=>da=e)}var ca=e=>{let t=G;return oa(e),e.scope.on(),()=>{e.scope.off(),oa(t)}},la=()=>{G&&G.scope.off(),oa(null)};function ua(e){return e.vnode.shapeFlag&4}var da=!1;function fa(e,t=!1,n=!1){t&&sa(t);let{props:r,children:i}=e.vnode,a=ua(e);si(e,r,a,t),bi(e,i,n||t);let o=a?pa(e,t):void 0;return t&&sa(!1),o}function pa(e,t){let n=e.type;e.accessCache=Object.create(null),e.proxy=new Proxy(e.ctx,yr);let{setup:r}=n;if(r){Ue();let n=e.setupContext=r.length>1?ya(e):null,i=ca(e),a=sn(r,e,0,[e.props,n]),o=y(a);if(We(),i(),(o||e.sp)&&!Bn(e)&&In(e),o){if(a.then(la,la),t)return a.then(n=>{ma(e,n,t)}).catch(t=>{ln(t,e,0)});e.asyncDep=a}else ma(e,a,t)}else _a(e,t)}function ma(e,t,n){h(t)?e.type.__ssrInlineRender?e.ssrRender=t:e.render=t:v(t)&&(e.setupState=Zt(t)),_a(e,n)}var ha,ga;function _a(e,t,n){let i=e.type;if(!e.render){if(!t&&ha&&!i.render){let t=i.template||Er(e).template;if(t){let{isCustomElement:n,compilerOptions:r}=e.appContext.config,{delimiters:a,compilerOptions:o}=i;i.render=ha(t,s(s({isCustomElement:n,delimiters:a},r),o))}}e.render=i.render||r,ga&&ga(e)}{let t=ca(e);Ue();try{Sr(e)}finally{We(),t()}}}var va={get(e,t){return k(e,`get`,``),e[t]}};function ya(e){return{attrs:new Proxy(e.attrs,va),slots:e.slots,emit:e.emit,expose:t=>{e.exposed=t||{}}}}function ba(e){return e.exposed?e.exposeProxy||=new Proxy(Zt(Ut(e.exposed)),{get(t,n){if(n in t)return t[n];if(n in _r)return _r[n](e)},has(e,t){return t in e||t in _r}}):e.proxy}function xa(e,t=!0){return h(e)?e.displayName||e.name:e.name||t&&e.__name}function Sa(e){return h(e)&&`__vccOpts`in e}var K=(e,t)=>$t(e,t,da);function Ca(e,t,n){try{Bi(-1);let r=arguments.length;return r===2?v(t)&&!d(t)?Ui(t)?H(e,null,[t]):H(e,t):H(e,null,t):(r>3?n=Array.prototype.slice.call(arguments,2):r===3&&Ui(n)&&(n=[n]),H(e,t,n))}finally{Bi(1)}}var wa=`3.5.25`,Ta=void 0,Ea=typeof window<`u`&&window.trustedTypes;if(Ea)try{Ta=Ea.createPolicy(`vue`,{createHTML:e=>e})}catch{}var Da=Ta?e=>Ta.createHTML(e):e=>e,Oa=`http://www.w3.org/2000/svg`,ka=`http://www.w3.org/1998/Math/MathML`,Aa=typeof document<`u`?document:null,ja=Aa&&Aa.createElement(`template`),Ma={insert:(e,t,n)=>{t.insertBefore(e,n||null)},remove:e=>{let t=e.parentNode;t&&t.removeChild(e)},createElement:(e,t,n,r)=>{let i=t===`svg`?Aa.createElementNS(Oa,e):t===`mathml`?Aa.createElementNS(ka,e):n?Aa.createElement(e,{is:n}):Aa.createElement(e);return e===`select`&&r&&r.multiple!=null&&i.setAttribute(`multiple`,r.multiple),i},createText:e=>Aa.createTextNode(e),createComment:e=>Aa.createComment(e),setText:(e,t)=>{e.nodeValue=t},setElementText:(e,t)=>{e.textContent=t},parentNode:e=>e.parentNode,nextSibling:e=>e.nextSibling,querySelector:e=>Aa.querySelector(e),setScopeId(e,t){e.setAttribute(t,``)},insertStaticContent(e,t,n,r,i,a){let o=n?n.previousSibling:t.lastChild;if(i&&(i===a||i.nextSibling))for(;t.insertBefore(i.cloneNode(!0),n),!(i===a||!(i=i.nextSibling)););else{ja.innerHTML=Da(r===`svg`?`<svg>${e}</svg>`:r===`mathml`?`<math>${e}</math>`:e);let i=ja.content;if(r===`svg`||r===`mathml`){let e=i.firstChild;for(;e.firstChild;)i.appendChild(e.firstChild);i.removeChild(e)}t.insertBefore(i,n)}return[o?o.nextSibling:t.firstChild,n?n.previousSibling:t.lastChild]}},Na=Symbol(`_vtc`);function Pa(e,t,n){let r=e[Na];r&&(t=(t?[t,...r]:[...r]).join(` `)),t==null?e.removeAttribute(`class`):n?e.setAttribute(`class`,t):e.className=t}var Fa=Symbol(`_vod`),Ia=Symbol(`_vsh`),La={name:`show`,beforeMount(e,{value:t},{transition:n}){e[Fa]=e.style.display===`none`?``:e.style.display,n&&t?n.beforeEnter(e):Ra(e,t)},mounted(e,{value:t},{transition:n}){n&&t&&n.enter(e)},updated(e,{value:t,oldValue:n},{transition:r}){!t!=!n&&(r?t?(r.beforeEnter(e),Ra(e,!0),r.enter(e)):r.leave(e,()=>{Ra(e,!1)}):Ra(e,t))},beforeUnmount(e,{value:t}){Ra(e,t)}};function Ra(e,t){e.style.display=t?e[Fa]:`none`,e[Ia]=!t}var za=Symbol(``),Ba=/(?:^|;)\s*display\s*:/;function Va(e,t,n){let r=e.style,i=g(n),a=!1;if(n&&!i){if(t)if(g(t))for(let e of t.split(`;`)){let t=e.slice(0,e.indexOf(`:`)).trim();n[t]??Ua(r,t,``)}else for(let e in t)n[e]??Ua(r,e,``);for(let e in n)e===`display`&&(a=!0),Ua(r,e,n[e])}else if(i){if(t!==n){let e=r[za];e&&(n+=`;`+e),r.cssText=n,a=Ba.test(n)}}else t&&e.removeAttribute(`style`);Fa in e&&(e[Fa]=a?r.display:``,e[Ia]&&(r.display=`none`))}var Ha=/\s*!important$/;function Ua(e,t,n){if(d(n))n.forEach(n=>Ua(e,t,n));else if(n??=``,t.startsWith(`--`))e.setProperty(t,n);else{let r=Ka(e,t);Ha.test(n)?e.setProperty(oe(r),n.replace(Ha,``),`important`):e[r]=n}}var Wa=[`Webkit`,`Moz`,`ms`],Ga={};function Ka(e,t){let n=Ga[t];if(n)return n;let r=C(t);if(r!==`filter`&&r in e)return Ga[t]=r;r=se(r);for(let n=0;n<Wa.length;n++){let i=Wa[n]+r;if(i in e)return Ga[t]=i}return t}var qa=`http://www.w3.org/1999/xlink`;function Ja(e,t,n,r,i,a=be(t)){r&&t.startsWith(`xlink:`)?n==null?e.removeAttributeNS(qa,t.slice(6,t.length)):e.setAttributeNS(qa,t,n):n==null||a&&!xe(n)?e.removeAttribute(t):e.setAttribute(t,a?``:_(n)?String(n):n)}function Ya(e,t,n,r,i){if(t===`innerHTML`||t===`textContent`){n!=null&&(e[t]=t===`innerHTML`?Da(n):n);return}let a=e.tagName;if(t===`value`&&a!==`PROGRESS`&&!a.includes(`-`)){let r=a===`OPTION`?e.getAttribute(`value`)||``:e.value,i=n==null?e.type===`checkbox`?`on`:``:String(n);(r!==i||!(`_value`in e))&&(e.value=i),n??e.removeAttribute(t),e._value=n;return}let o=!1;if(n===``||n==null){let r=typeof e[t];r===`boolean`?n=xe(n):n==null&&r===`string`?(n=``,o=!0):r===`number`&&(n=0,o=!0)}try{e[t]=n}catch{}o&&e.removeAttribute(i||t)}function Xa(e,t,n,r){e.addEventListener(t,n,r)}function Za(e,t,n,r){e.removeEventListener(t,n,r)}var Qa=Symbol(`_vei`);function $a(e,t,n,r,i=null){let a=e[Qa]||(e[Qa]={}),o=a[t];if(r&&o)o.value=r;else{let[n,s]=to(t);r?Xa(e,n,a[t]=ao(r,i),s):o&&(Za(e,n,o,s),a[t]=void 0)}}var eo=/(?:Once|Passive|Capture)$/;function to(e){let t;if(eo.test(e)){t={};let n;for(;n=e.match(eo);)e=e.slice(0,e.length-n[0].length),t[n[0].toLowerCase()]=!0}return[e[2]===`:`?e.slice(3):oe(e.slice(2)),t]}var no=0,ro=Promise.resolve(),io=()=>no||=(ro.then(()=>no=0),Date.now());function ao(e,t){let n=e=>{if(!e._vts)e._vts=Date.now();else if(e._vts<=n.attached)return;cn(oo(e,n.value),t,5,[e])};return n.value=e,n.attached=io(),n}function oo(e,t){if(d(t)){let n=e.stopImmediatePropagation;return e.stopImmediatePropagation=()=>{n.call(e),e._stopped=!0},t.map(e=>t=>!t._stopped&&e&&e(t))}else return t}var so=e=>e.charCodeAt(0)===111&&e.charCodeAt(1)===110&&e.charCodeAt(2)>96&&e.charCodeAt(2)<123,co=(e,t,n,r,i,s)=>{let c=i===`svg`;t===`class`?Pa(e,r,c):t===`style`?Va(e,n,r):a(t)?o(t)||$a(e,t,n,r,s):(t[0]===`.`?(t=t.slice(1),!0):t[0]===`^`?(t=t.slice(1),!1):lo(e,t,r,c))?(Ya(e,t,r),!e.tagName.includes(`-`)&&(t===`value`||t===`checked`||t===`selected`)&&Ja(e,t,r,c,s,t!==`value`)):e._isVueCE&&(/[A-Z]/.test(t)||!g(r))?Ya(e,C(t),r,s,t):(t===`true-value`?e._trueValue=r:t===`false-value`&&(e._falseValue=r),Ja(e,t,r,c))};function lo(e,t,n,r){if(r)return!!(t===`innerHTML`||t===`textContent`||t in e&&so(t)&&h(n));if(t===`spellcheck`||t===`draggable`||t===`translate`||t===`autocorrect`||t===`sandbox`&&e.tagName===`IFRAME`||t===`form`||t===`list`&&e.tagName===`INPUT`||t===`type`&&e.tagName===`TEXTAREA`)return!1;if(t===`width`||t===`height`){let t=e.tagName;if(t===`IMG`||t===`VIDEO`||t===`CANVAS`||t===`SOURCE`)return!1}return so(t)&&g(n)?!1:t in e}var uo=e=>{let t=e.props[`onUpdate:modelValue`]||!1;return d(t)?e=>ue(t,e):t};function fo(e){e.target.composing=!0}function po(e){let t=e.target;t.composing&&(t.composing=!1,t.dispatchEvent(new Event(`input`)))}var mo=Symbol(`_assign`);function ho(e,t,n){return t&&(e=e.trim()),n&&(e=de(e)),e}var go={created(e,{modifiers:{lazy:t,trim:n,number:r}},i){e[mo]=uo(i);let a=r||i.props&&i.props.type===`number`;Xa(e,t?`change`:`input`,t=>{t.target.composing||e[mo](ho(e.value,n,a))}),(n||a)&&Xa(e,`change`,()=>{e.value=ho(e.value,n,a)}),t||(Xa(e,`compositionstart`,fo),Xa(e,`compositionend`,po),Xa(e,`change`,po))},mounted(e,{value:t}){e.value=t??``},beforeUpdate(e,{value:t,oldValue:n,modifiers:{lazy:r,trim:i,number:a}},o){if(e[mo]=uo(o),e.composing)return;let s=(a||e.type===`number`)&&!/^0\d/.test(e.value)?de(e.value):e.value,c=t??``;s!==c&&(document.activeElement===e&&e.type!==`range`&&(r&&t===n||i&&e.value.trim()===c)||(e.value=c))}},_o=[`ctrl`,`shift`,`alt`,`meta`],vo={stop:e=>e.stopPropagation(),prevent:e=>e.preventDefault(),self:e=>e.target!==e.currentTarget,ctrl:e=>!e.ctrlKey,shift:e=>!e.shiftKey,alt:e=>!e.altKey,meta:e=>!e.metaKey,left:e=>`button`in e&&e.button!==0,middle:e=>`button`in e&&e.button!==1,right:e=>`button`in e&&e.button!==2,exact:(e,t)=>_o.some(n=>e[`${n}Key`]&&!t.includes(n))},yo=(e,t)=>{let n=e._withMods||={},r=t.join(`.`);return n[r]||(n[r]=((n,...r)=>{for(let e=0;e<t.length;e++){let r=vo[t[e]];if(r&&r(n,t))return}return e(n,...r)}))},bo=s({patchProp:co},Ma),xo;function So(){return xo||=Si(bo)}var Co=((...e)=>{let t=So().createApp(...e),{mount:n}=t;return t.mount=e=>{let r=To(e);if(!r)return;let i=t._component;!h(i)&&!i.render&&!i.template&&(i.template=r.innerHTML),r.nodeType===1&&(r.textContent=``);let a=n(r,!1,wo(r));return r instanceof Element&&(r.removeAttribute(`v-cloak`),r.setAttribute(`data-v-app`,``)),a},t});function wo(e){if(e instanceof SVGElement)return`svg`;if(typeof MathMLElement==`function`&&e instanceof MathMLElement)return`mathml`}function To(e){return g(e)?document.querySelector(e):e}const Eo={CSSStyleSheet:!0,CSSContainer:CSS.supports(`container-type`,`size`)};try{new CSSStyleSheet}catch{Eo.CSSStyleSheet=!1}var Do=(e,t)=>{for(let n of t){if(!Eo.CSSStyleSheet){let t=document.createElement(`style`);t.textContent=n,e.insertBefore(t,e.firstChild);continue}let t=new CSSStyleSheet;t.replaceSync(n),e.adoptedStyleSheets=[...e.adoptedStyleSheets,t]}};const q=e=>{let t={},n={};for(let r in e){let i=e[r],a={key:r,sync:!0,types:[]};r.startsWith(`$`)&&(a.key=r.slice(1),a.sync=!1),Array.isArray(i)&&(a.types=i,i=a.types[0]),t[a.key]=i,n[a.key]={sync:a.sync,def:i,to:e=>{switch(typeof i){case`string`:let t=String(e);return a.types.length>0?a.types.includes(t)?t:a.types[0]:t;case`number`:let n=Number(e);return isNaN(n)?i:n;case`boolean`:return typeof e==`boolean`?e:e===`true`}}}}return Object.defineProperty(t,`$meta`,{value:n}),t},Oo=e=>e;var ko=`
:host{
  user-select: none;
...
<slot name="end"></slot>
`;(class extends J({style:Mo,template:No,props:jo}){}).define(Ao);var Po=`s-appbar`,Fo=`
:host{
  display: flex;
  align-items: center;
  position: relative;
...
<slot name="end"></slot>
`;(class extends J({style:Fo,template:Io,setup(e){let t=e.querySelector(`.view`);Eo.CSSContainer||new ResizeObserver(()=>{t.classList.toggle(`s-laptop`,this.offsetWidth<=1024),t.classList.toggle(`s-tablet`,this.offsetWidth<=768)}).observe(this)}}){}).define(Po);var Lo=`s-avatar`,Ro=q({$src:``}),zo=`
:host{
  display: inline-flex;
...
`;(class extends J({style:zo,template:Bo,props:Ro,setup(e){let t=document.createElement(`img`);return{src:n=>{t.src=n,t.onload=()=>{this.dispatchEvent(new Event(`load`)),e.insertBefore(t,e.children[0])},t.onerror=()=>{this.dispatchEvent(new ErrorEvent(`error`)),t.isConnected&&e.removeChild(t)}}}}}){}).define(Lo);var Vo=`s-badge`,Ho=`
:host{
  display: inline-flex;
  justify-content: center;
  align-items: center;
...
`;(class extends J({style:Ho,template:Uo}){}).define(Vo);const Wo=e=>{let t=e.trim().match(/^([\d\.]+)(s|ms)$/);if(!t)throw Error();let n=Number(t[1]);return t[2]===`s`?n*1e3:n};var Go=`s-bottom-sheet`,Ko=q({showed:!1,disabledGesture:!1}),qo=Oo({show:CustomEvent,showed:Event,close:CustomEvent,closed:Event}),Jo=`
:host{
...
`;(class extends J({style:os,template:ss,props:as}){}).define(is);var cs=`s-card`,ls=q({type:[`elevated`,`filled`,`outlined`],clickable:!1}),us=`
:host{
  display: inline-block;
  vertical-align: middle;
  border-radius: 12px;
...
`,xs=`<slot></slot>`,Ss=class extends J({style:bs,template:xs,props:ys,setup(){return{selected:()=>{this.parentNode instanceof _s&&this.dispatchEvent(new Event(`${ps}:update`,{bubbles:!0}))}}}}){};_s.define(ps),Ss.define(vs);var Cs=`s-checkbox`,ws=q({disabled:!1,checked:!1,indeterminate:!1}),Ts=`
:host{
  display: inline-flex;
  align-items: center;
  vertical-align: middle;
...
<slot></slot>
<s-ripple class="ripple" attached="true" part="ripple"></s-ripple>
`;(class extends J({style:Ts,template:Es,props:ws,setup(){this.addEventListener(`click`,()=>{this.indeterminate&&=!1,this.checked=!this.checked,this.dispatchEvent(new Event(`change`))})}}){}).define(Cs);var Ds=`s-chip`,Os=q({type:[`filled`,`outlined`],$value:``,checked:!1,disabled:!1,clickable:!1}),ks=`
:host{
  display: inline-flex;
  align-items: center;
  vertical-align: middle;
...
<slot name="action"></slot>
<s-ripple class="ripple" attached="true" part="ripple"></s-ripple>
`;(class extends J({style:ks,template:As,props:Os,setup(e){let t=e.querySelector(`slot[name=action]`);t.onclick=e=>e.stopPropagation(),t.onpointerdown=e=>e.stopPropagation(),this.addEventListener(`click`,()=>{this.clickable&&(this.checked=!this.checked,this.dispatchEvent(new Event(`change`)))})}}){}).define(Ds);var js=`s-circular-progress`,Ms=q({indeterminate:!1,animated:!1,$max:100,$value:0}),Ns=`
:host{
  display: inline-block;
  vertical-align: middle;
  position: relative;
...
`,Ps=48,Fs=4,Is=(Ps-Fs)*Math.PI,Ls=`
<div class="container known">
  <svg viewBox="0 0 48 48" style="transform: rotate(-90deg);--dasharray: ${Is}px;">
    <circle class="track block" cx="${Ps/2}" cy="${Ps/2}" r="${(Ps-Fs)/2}" style="stroke-width: ${Fs}px" />
    <circle class="indicator block" cx="${Ps/2}" cy="${Ps/2}" r="${(Ps-Fs)/2}" style="stroke-dashoffset: ${Is}px;stroke-width: ${Fs}px" />
  </svg>
</div>
<div class="container unknown">
  <svg viewBox="0 0 48 48" style="animation: stroke-rotate 5.2s ease-in-out infinite;--dasharray: ${Is}px;">
    <circle transform="rotate(-90, ${Ps/2}, ${Ps/2})" cx="${Ps/2}" cy="${Ps/2}" r=" ${(Ps-Fs)/2}" style="animation: stroke 1.3s ease-in-out infinite;stroke-width: ${Fs}px"></circle>
  </svg>
</div>
`;(class extends J({style:Ns,template:Ls,props:Ms,setup(e){let t=e.querySelector(`.known .track`),n=e.querySelector(`.known .indicator`),r=()=>{let e=Math.min(this.value,this.max)/this.max*100,r=Is-Is*(e/100),i=e/100*360;t.style.strokeDashoffset=`${e===0?0:Math.min(Is+16-r,Is)}px`,t.setAttribute(`transform`,`rotate(${i+20}, ${Ps/2}, ${Ps/2})`),n.style.strokeDashoffset=`${r}px`};return{max:r,value:r}}}){}).define(js);const Rs=(e,t=`yyyy-MM-dd`)=>{typeof e==`string`&&(e=new Date(e));let n=e.getFullYear(),r=e.getMonth()+1,i=e.getDate();return t.replace(`yyyy`,n.toString()).replace(`MM`,r.toString().padStart(2,`0`)).replace(`dd`,i.toString().padStart(2,`0`))};var zs=new class{list;locale=navigator.language;updates=new Map;constructor(e){this.list=e}getItem(e){if(e||=this.locale,e in this.list)return this.list[e];let[t]=e.split(`-`);return t in this.list?this.list[t]:this.list.zh}addItem(e,t){if(this.list[e])throw Error(`Locale ${e} already exists`);this.list[e]=t}setLocale(e){this.locale=e??navigator.language,this.updates.forEach(e=>e())}}({});zs.list={zh:{display:e=>`${e.getFullYear()}年${e.getMonth()+1}月${e.getDate()}日 星期${zs.list.zh.displayWeeks[e.getDay()]}`,displayMonth:e=>`${e.getFullYear()}年`,displayWeeks:[`日`,`一`,`二`,`三`,`四`,`五`,`六`]},en:{display:e=>`${[`Sun`,`Mon`,`Tue`,`Wed`,`Thu`,`Fri`,`Sat`][e.getDay()]}, Jan ${e.getDate()}`,displayMonth:e=>`${[`January`,`February`,`March`,`April`,`May`,`June`,`July`,`August`,`September`,`October`,`November`,`December`][e.getMonth()]} ${e.getFullYear()}`,displayWeeks:[`S`,`M`,`T`,`W`,`T`,`F`,`S`]}};var Bs=`s-date`,Vs=q({$value:``,$locale:``,$max:`2099-12-31`,$min:`1900-01-01`}),Hs=`
:host{
  display: inline-block;
  vertical-align: middle;
  border-radius: 8px;
...
`,Us={years:[],weeks:[],days:[]};for(let e=0;e<200;e++)e<7&&Us.weeks.push(`<div class="item"></div>`),e<31&&Us.days.push(`<div class="item"><s-ripple class="icon-button">${e+1}</s-ripple></div>`),Us.years.push(`<s-ripple class="button item"></s-ripple>`);var Ws=`
...
`,Gs=class{yearSelect;daySelect;dayOverflow;date;min;max;constructor(e,t,n){this.date=typeof e==`string`?new Date(e):e,this.min=new Date(t),this.max=new Date(n)}},Ks=(e,t)=>{let n=new Date(e,t+1,1);return n.setDate(n.getDate()-1),n.getDate()},qs=(e,t)=>{zs.addItem(e,t)},Js=e=>{zs.setLocale(e)};(class extends J({style:Hs,template:Ws,props:Vs,methods:{addLocale:qs,setLocale:Js},setup(e){let t=e.querySelector(`.container`),n=e.querySelector(`.header>span`),r=e.querySelector(`.action>.year`),i=e.querySelector(`.action>.toggle>.prev`),a=e.querySelector(`.action>.toggle>.next`),o=e.querySelector(`.years`),s=e.querySelector(`.weeks`),c=e.querySelector(`.days`),l=new Gs(this.value||new Date,this.min,this.max),u=()=>{let e=zs.getItem(this.locale).display;n.textContent=e(l.date);let t=zs.getItem(this.locale).displayMonth;r.children[0].textContent=t(l.date)},d=()=>{let e=zs.getItem(this.locale).displayWeeks;s.childNodes.forEach((t,n)=>t.textContent=e[n])},f=()=>{let e=new Date(l.date.getFullYear(),l.date.getMonth(),1).getDay();c.children[0].setAttribute(`style`,`margin-left: calc((100% / 7) * ${e})`);let n=new Date(l.date.getFullYear(),l.date.getMonth()+1,0).getDate();l.dayOverflow?.classList.remove(`overflow`),l.dayOverflow=c.children[n-1],l.dayOverflow.classList.add(`overflow`),l.yearSelect?.classList.remove(`checked`),l.yearSelect=o.children[l.date.getFullYear()-l.min.getFullYear()],l.yearSelect.classList.add(`checked`),l.daySelect?.classList.remove(`checked`),l.daySelect=c.children[l.date.getDate()-1],l.daySelect.classList.add(`checked`),t.style.removeProperty(`height`)},p=()=>{let e=l.max.getFullYear()-l.min.getFullYear();o.innerHTML=``,o.style.counterReset=`year-counter ${l.min.getFullYear()-1}`;let t=document.createDocumentFragment();for(let n=0;n<=e;n++){let e=new rs;e.classList.add(`button`,`item`),t.appendChild(e)}o.appendChild(t),f()},m=(e,t,n)=>{this.value=Rs(new Date(e,t,n)),this.dispatchEvent(new Event(`change`))};r.onclick=()=>{let e=t.offsetHeight;if(t.classList.toggle(`show-years`),t.classList.contains(`show-years`)){t.style.height=`${e}px`,l.yearSelect&&o.scrollTo({top:l.yearSelect.offsetTop-o.offsetHeight/2+l.yearSelect.offsetHeight/2});return}},i.onclick=()=>{let e=Ks(l.date.getFullYear(),l.date.getMonth()-1),t=Math.min(l.date.getDate(),e);m(l.date.getFullYear(),l.date.getMonth()-1,t)},a.onclick=()=>{let e=Ks(l.date.getFullYear(),l.date.getMonth()+1),t=Math.min(l.date.getDate(),e);m(l.date.getFullYear(),l.date.getMonth()+1,t)},o.onclick=e=>{e.target instanceof rs&&(t.classList.remove(`show-years`),m(Array.from(o.children).indexOf(e.target)+l.min.getFullYear(),l.date.getMonth(),l.date.getDate()))},c.onclick=e=>{if(!(e.target instanceof rs))return;let t=Array.from(c.children).indexOf(e.target.parentElement)+1;m(l.date.getFullYear(),l.date.getMonth(),t)};let h=()=>{u(),d()};return f(),h(),{onMounted:()=>zs.updates.set(this,h),onUnmounted:()=>zs.updates.delete(this),min:e=>{let t=new Date(e);if(isNaN(t.getTime())||t.getTime()>l.date.getTime())throw Error(`invalid min date`);l.min=t,p()},max:e=>{let t=new Date(e);if(isNaN(t.getTime())||t.getTime()<l.date.getTime())throw Error(`invalid max date`);l.max=t,p()},value:{get:()=>Rs(l.date),set:e=>{let t=new Date(e);if(isNaN(t.getTime())||t.getTime()<l.min.getTime()||t.getTime()>l.max.getTime())throw Error(`invalid date`);l.date=t,u(),f()}},locale:h}}}){}).define(Bs);var Ys=`s-date-picker`,Xs=q({$value:``,$min:``,$max:``,$label:``,$positiveText:`确定`,$negativeText:`取消`,$format:`yyyy-MM-dd`,$locale:``}),Zs=`
:host{
  display: inline-block;
  vertical-align: middle;
  font-size: .875rem;
...
<s-dialog part="dialog">
  ...
  <s-ripple class="negative" slot="action" part="negative">${Xs.negativeText}</s-ripple>
  <s-ripple class="positive" slot="action" part="positive">${Xs.positiveText}</s-ripple>
</s-dialog>
`;(class extends J({style:Zs,template:Qs,props:Xs,setup(e){let t=e.querySelector(`s-dialog`),n=e.querySelector(`s-date`),r=e.querySelector(`.negative`),i=e.querySelector(`.positive`),a=e.querySelector(`s-field`),o=e.querySelector(`.label`),s=e.querySelector(`.view`),c={date:``};return t.addEventListener(`show`,()=>{a.fixed=!0,a.focused=!0,c.date||(s.textContent=this.label,s.style.opacity=`0`)}),t.onclose=()=>{a.focused=!1,c.date||(a.fixed=!1)},i.onclick=()=>{this.value=n.value,s.style.removeProperty(`opacity`),this.dispatchEvent(new Event(`change`))},{value:{get:()=>c.date,set:e=>{if(c.date=e,e===``){n.value=Rs(new Date),a.fixed=!1,s.textContent=``;return}a.fixed=!0,s.textContent=Rs(e,this.format),n.value=e}},locale:{get:()=>n.locale,set:e=>n.locale=e},min:{get:()=>n.min,set:e=>n.min=e},max:{get:()=>n.max,set:e=>n.max=e},label:e=>o.textContent=e,positiveText:e=>i.textContent=e,negativeText:e=>r.textContent=e}}}){}).define(Ys);var $s=`s-scroll-view`,ec=`
:host{
  display: block;
  overflow: auto;
}
...
`,tc=`<slot></slot>`;(class extends J({style:ec,template:tc}){}).define($s);var nc=`s-dialog`,rc=q({showed:!1,size:[`standard`,`full`]}),ic=Oo({show:CustomEvent,showed:Event,close:CustomEvent,closed:Event}),ac=`
:host{
  display: inline-block;
  vertical-align: middle;
}
...
`,sc=e=>{let t=document.body,n=new cc,r=document.body.firstElementChild;if(r&&r.tagName===`S-PAGE`&&(t=r),typeof e==`string`){let t=document.createElement(`div`);t.slot=`text`,t.textContent=e,n.appendChild(t)}else{if(e.root&&(t=e.root),e.headline){let t=document.createElement(`div`);t.slot=`headline`,t.textContent=e.headline,n.appendChild(t)}if(e.text){let t=document.createElement(`div`);t.slot=`text`,t.textContent=e.text,n.appendChild(t)}e.view&&(typeof e.view==`function`?e.view(n):n.appendChild(e.view));let r=e.actions??[];for(let e of Array.isArray(r)?r:[r]){let t=document.createElement(`s-button`);t.slot=`action`,t.type=`text`,t.textContent=e.text,e.click&&(t.onclick=e.click),n.appendChild(t)}}return n.showed=!0,n.addEventListener(`closed`,()=>t.removeChild(n)),t.appendChild(n),n},cc=class extends J({style:ac,template:oc,props:rc,events:ic,methods:{builder:sc},setup(e){let t=e.querySelector(`dialog`),n=e.querySelector(`.scrim`),r=e.querySelector(`.wrapper`),i=getComputedStyle(this),a=()=>({easing:i.getPropertyValue(`--s-motion-easing-standard`)||`cubic-bezier(0.2, 0, 0, 1.0)`,duration:Wo(i.getPropertyValue(`--s-motion-duration-medium4`)||`400ms`)});e.querySelector(`slot[name=trigger]`).onclick=()=>{if(this.showed||!this.dispatchEvent(new CustomEvent(`show`,{cancelable:!0,detail:{source:`TRIGGER`}})))return console.log(`拒绝`);this.showed=!0};let o=e=>{!this.showed||!this.dispatchEvent(new CustomEvent(`close`,{cancelable:!0,detail:{source:e}}))||(this.showed=!1)};e.querySelector(`.scrim`).onclick=()=>o(`SCRIM`),e.querySelector(`slot[name=action]`).onclick=()=>o(`ACTION`);let s=()=>{if(!this.isConnected||t.open)return;let e=a();t.showModal(),t.classList.add(`show`),n.animate({opacity:[0,1]},e),r.animate({transform:[`scale(.9)`,`scale(1)`],opacity:[0,1]},e).addEventListener(`finish`,()=>this.dispatchEvent(new Event(`showed`)))},c=()=>{if(!this.isConnected||!t.open)return;let e=a();n.animate({opacity:[1,0]},e),r.animate({transform:[`scale(1)`,`scale(.9)`],opacity:[1,0]},e).addEventListener(`finish`,()=>{t.close(),t.classList.remove(`show`),this.dispatchEvent(new Event(`closed`))})};return{onMounted:()=>this.showed&&!t.open&&s(),showed:e=>e?s():c()}}}){};cc.define(nc);var lc=`s-divider`,uc=`
:host{
  display: flex;
  align-items: center;
  margin: 0 16px;
...
`,dc=`<slot></slot>`;(class extends J({style:uc,template:dc}){}).define(lc);var fc=`s-drawer`,pc=`
:host{
  display: flex;
  height: 100%;
  overflow: hidden;
...
<slot></slot>`;(class extends J({style:gc,template:_c}){}).define(hc);var vc=`s-fab`,yc=q({hidden:!1,disabled:!1}),bc=`
:host{
  display: inline-flex;
  vertical-align: middle;
  justify-content: center;
...
`;(class extends J({style:bc,template:xc,props:yc}){}).define(vc);var Sc=`s-icon-button`,Cc=q({disabled:!1,type:[`standard`,`filled`,`filled-tonal`,`outlined`]}),wc=`
:host{
  display: inline-flex;
  vertical-align: middle;
  justify-content: center;
...
`,Ac=`<slot></slot>`;(class extends J({style:kc,template:Ac,props:Oc,setup(e){let t=e.querySelector(`slot`),n=document.createElement(`img`),r=(e=Ec.none,t=``)=>`<svg viewBox="0 -960 960 960"><path d="${e}" transform="${t}"></path></svg>`;return{name:e=>{let n=Ec[e];if(typeof n==`string`)return t.innerHTML=r(n);let i=n.name;typeof Ec[i]==`string`&&(t.innerHTML=r(Ec[i],`rotate(${n.angle} 480 -480)`))},src:async()=>{try{let e=new URL(this.src,location.href);if(e.pathname.endsWith(`.svg`)){let n=await(await fetch(e.href)).text(),r=document.createElement(`template`);r.innerHTML=n;let i=r.content.childNodes[0];if(!(i instanceof SVGElement))throw Error(`Invalid SVG`);t.innerHTML=``,t.appendChild(i),this.dispatchEvent(new Event(`load`))}else n.src=e.href,n.onload=()=>{t.innerHTML=``,t.appendChild(n),this.dispatchEvent(new Event(`load`))},n.onerror=()=>this.dispatchEvent(new ErrorEvent(`error`))}catch{this.dispatchEvent(new ErrorEvent(`error`))}}}}}){}).define(Dc);var jc=`s-linear-progress`,Mc=q({indeterminate:!1,animated:!1,$max:100,$value:0}),Nc=`
:host{
  display: block;
  height: 4px;
  color: var(--s-color-primary, #006782);
...
`;(class extends J({style:Nc,template:Pc,props:Mc,setup(e){let t=e.querySelector(`.known>.track`),n=e.querySelector(`.known>.indicator`),r=()=>{let e=Math.min(this.value,this.max)/this.max*100;t.style.transform=`translateX(calc(${e}% + ${e===0?0:4}px))`,n.style.transform=`translateX(${e-100}%)`};return{max:r,value:r}}}){}).define(jc);var Fc=`s-menu`,Ic=`
:host{
  display: flex;
  flex-direction: column;
  font-size: .875rem;
...
<slot></slot>
`,Rc=class extends J({style:Ic,template:Lc}){},zc=`s-menu-item`,Bc=q({checked:!1,folded:!0}),Vc=`
:host{
  display: flex;
  flex-direction: column;
...
<s-fold class="fold" part="fold" folded="${Bc.folded}">
  <slot name="menu" class="menu"></slot>
</s-fold>
`,Uc=class extends J({style:Vc,template:Hc,props:Bc,setup(e){let t=e.querySelector(`.container`),n=e.querySelector(`.fold`),r=e.querySelector(`slot[name=menu]`);return n.onclick=e=>e.stopPropagation(),r.onslotchange=()=>t.classList[r.assignedElements().length>0?`add`:`remove`](`show-menu`),t.onclick=()=>{t.classList.contains(`show-menu`)&&(this.folded=!this.folded)},{folded:e=>n.folded=e}}}){};Rc.define(Fc),Uc.define(zc);var Wc=`s-navigation`,Gc=q({mode:[`bottom`,`rail`],$value:``}),Kc=`
:host{
  display: flex;
  justify-content: center;
  align-items: center;
...
<slot id="slot"></slot>
<slot name="end"></slot>
`,Jc=class extends J({style:Kc,template:qc,props:Gc,setup(e){let t=e.querySelector(`#slot`),n=new fs({context:this,class:$c,slot:t});return{expose:{get options(){return n.list},get selectedIndex(){return n.selectedIndex}},value:{get:()=>n.value,set:e=>n.value=e}}}}){},Yc=`s-navigation-item`,Xc=q({selected:!1,$value:``}),Zc=`
:host{
  display: flex;
  align-items: center;
  justify-content: center;
...
<slot name="text"></slot>
`,$c=class extends J({style:Zc,template:Qc,props:Xc,setup(){return this.addEventListener(`click`,()=>{this.selected||this.parentNode instanceof Jc&&this.dispatchEvent(new Event(`${Wc}:select`,{bubbles:!0}))}),{selected:()=>{this.parentNode instanceof Jc&&this.dispatchEvent(new Event(`${Wc}:update`,{bubbles:!0}))}}}}){};Jc.define(Wc),$c.define(Yc);var el=`s-field`,tl=q({focused:!1,fixed:!0}),nl=`
:host{
  display: inline-block;
  vertical-align: middle;
  font-size: .875rem;
...
`;(class extends J({style:nl,template:rl,props:tl}){}).define(el);var il=`s-fold`,al=q({folded:!1}),ol=`
:host{
  display: block;
}
.container{
...
`;(class extends J({style:ol,template:sl,props:al,setup(e){e.querySelector(`slot[name=trigger]`).onclick=()=>this.folded=!this.folded}}){}).define(il);var cl=`s-page`,ll=q({theme:[`light`,`auto`,`dark`]}),ul=`
:host{
  display: flow-root;
  height: 100%;
...
`,dl=`<slot></slot>`,fl=document.createElement(`style`);fl.textContent=`::view-transition-old(root),::view-transition-new(root) { animation: none; mix-blend-mode: normal}`,class extends J({style:ul,template:dl,props:ll,setup(){let e=getComputedStyle(this),t=matchMedia(`(prefers-color-scheme: dark)`),n=()=>({easing:e.getPropertyValue(`--s-motion-easing-standard-accelerate`)||`cubic-bezier(0.3, 0, 1, 1)`,duration:Wo(e.getPropertyValue(`--s-motion-duration-long4`)||`600ms`)}),r=()=>this.theme===`auto`?t.matches:this.theme===`dark`;return{expose:{toggle:(e,r)=>new Promise(i=>{if(this.theme===e)return;let a=t.matches,o=e=>e===`auto`?a?`dark`:`light`:e;if(o(this.theme)===o(e)||!document.startViewTransition)return this.theme=e,i();let s=innerWidth,c=innerHeight,l={clipPath:[`circle(0px at 50% ${c/2}px)`,`circle(${Math.sqrt(s**2+c**2)/2}px at 50% ${c/2}px)`]};if(r&&r.isConnected){let{left:e,top:t}=r.getBoundingClientRect(),n=e+r.offsetWidth/2,i=t+r.offsetHeight/2,a=Math.max(s-n,n),o=Math.max(c-i,i),u=Math.sqrt(a**2+o**2);l.clipPath[0]=`circle(0px at ${n}px ${i}px)`,l.clipPath[1]=`circle(${u}px at ${n}px ${i}px)`}let u=document.startViewTransition(()=>{this.theme=e,document.head.appendChild(fl)});u.ready.then(async()=>{i(document.documentElement.animate(l,{...n(),pseudoElement:`::view-transition-new(root)`})),await u.finished,fl.remove()})}),get isDark(){return r()}},theme:e=>{if(e===`light`)return this.removeAttribute(`dark`);if(e===`dark`)return this.setAttribute(`dark`,``);let n=()=>{t.matches?this.setAttribute(`dark`,``):this.removeAttribute(`dark`),this.dispatchEvent(new Event(`change`))};t.onchange=n,n()}}}}){}.define(cl);var pl=`s-pagination`,ml=q({$value:1,$total:20,$count:20,type:[`standard`,`outlined`]}),hl=`
:host{
  display: inline-flex;
  justify-content: center;
  align-items: center;
...
`;(class extends J({style:hl,template:gl,props:ml,setup(e){let t=e.querySelector(`.prev`),n=e.querySelector(`.next`),r=e.querySelector(`.container`),i=()=>this.dispatchEvent(new Event(`change`)),a=()=>{let e=Math.ceil(this.total/this.count),i=Math.max(Math.min(e-7,Math.max(0,this.value-4)),0);if(r.childNodes.forEach(e=>{i++;let t=e;t.textContent=i.toString(),t.classList.toggle(`checked`,this.value===i),t.classList.remove(`text`)}),t.classList.toggle(`disabled`,this.value===1),n.classList.toggle(`disabled`,this.value===e),e>7){if(this.value>=5){r.childNodes.item(0).textContent=`1`;let e=r.childNodes.item(1);e.textContent=`...`,e.classList.add(`text`)}if(this.value<=e-4){r.childNodes.item(r.childNodes.length-1).textContent=e.toString();let t=r.childNodes.item(r.childNodes.length-2);t.textContent=`...`,t.classList.add(`text`)}}};return r.onclick=e=>{if(!(e.target instanceof rs))return;let t=Number(e.target.textContent);t!==this.value&&(this.value=t,i())},t.onclick=()=>{let e=Math.max(this.value-1,1);e!==this.value&&(this.value=e,i())},n.onclick=()=>{let e=Math.min(this.value+1,Math.ceil(this.total/this.count));e!==this.value&&(this.value=e,i())},{total:()=>{let e=Math.ceil(this.total/this.count),t=Math.min(e,7),n=document.createDocumentFragment();for(let e=1;e<=t;e++){let e=new rs;e.classList.add(`button`),n.appendChild(e)}r.innerHTML=``,r.appendChild(n),a()},value:a}}}){}).define(pl);var _l=`s-picker`,vl=q({disabled:!1,$label:``,$value:``}),yl=`
:host{
  display: inline-block;
  vertical-align: middle;
  font-size: .875rem;
...
`,El=class extends J({style:wl,template:Tl,props:Cl,setup(){return this.addEventListener(`click`,()=>{this.selected||this.parentNode instanceof xl&&this.dispatchEvent(new Event(`${_l}:select`,{bubbles:!0}))}),{selected:()=>{this.parentNode instanceof xl&&this.dispatchEvent(new Event(`${_l}:update`,{bubbles:!0}))}}}}){};xl.define(_l),El.define(Sl);var Dl=`s-popup`,Ol=q({align:[`center`,`left`,`right`]}),kl=Oo({show:Event,showed:Event,closed:Event}),Al=`
:host{
  display: inline-block;
  vertical-align: middle;
  text-align: left;
...
`,Ll=class e extends J({style:Fl,template:Il,props:Pl,setup(t){let n=t.querySelector(`.popup`),r=t.querySelector(`slot[name=trigger]`);return r.onclick=e=>{e.stopPropagation(),n.show()},this.addEventListener(`${Nl}:click`,e=>{e.stopPropagation(),n.close()}),n.onclose=t=>{let n=t.target;if(n.parentNode instanceof ShadowRoot){let t=n.parentNode.host;t.parentNode instanceof e&&t.parentNode.close()}},{onMounted:()=>{this.parentNode instanceof e&&n.setAttribute(`align`,`right`)},expose:{get show(){return n.show},get toggle(){return n.toggle},get close(){return n.close}}}}}){},Rl=`s-popup-menu-item`,zl=`
:host{
  display: flex;
  align-items: center;
  height: 40px;
...
`,Vl=class extends J({style:zl,template:Bl,setup(){this.addEventListener(`click`,()=>this.dispatchEvent(new Event(`${Nl}:click`,{bubbles:!0})))}}){};Ll.define(Nl),Vl.define(Rl);var Hl=`s-radio-button`,Ul=q({disabled:!1,checked:!1,name:``,$value:``}),Wl=`
:host{
  display: inline-flex;
  vertical-align: middle;
  align-items: center;
...
<slot></slot>
<s-ripple class="ripple" attached="true" part="ripple"></s-ripple>
`;(class extends J({style:Wl,template:Gl,props:Ul,setup(){this.addEventListener(`click`,()=>{this.checked=!0,this.name&&document.querySelectorAll(`${this.tagName}[name='${this.name}']`).forEach(e=>{e!==this&&(e.checked=!1)}),this.dispatchEvent(new Event(`change`))})}}){}).define(Hl);var Kl=`s-rate`,ql=q({readOnly:!1,$max:10,$min:0,$value:5,$step:1}),Jl=`
:host{
  display: inline-flex;
  vertical-align: middle;
  overflow: hidden;
...
<input
  ...
  value="${ql.value}"
/>
`;(class extends J({style:Jl,template:Yl,props:ql,setup(e){let t=e.querySelector(`.indicator`),n=e.querySelector(`input`),r=()=>{let e=(Number(n.value)-this.min)*100/this.max-this.min;t.style.width=`${e}%`};return n.onchange=()=>this.dispatchEvent(new Event(`change`)),n.oninput=()=>{this.value=Number(n.value),this.dispatchEvent(new Event(`input`))},{max:e=>{n.max=String(e),r()},min:e=>{n.min=String(e),r()},step:e=>{n.step=String(e),r()},value:e=>{n.value=String(e),r()}}}}){}).define(Kl);var Xl=`s-search`,Zl=q({$placeholder:``,disabled:!1,$value:``,$maxLength:-1,readOnly:!1}),Ql=`
:host{
  display: inline-flex;
  vertical-align: middle;
  min-height: 40px;
...
`;(class extends J({style:Ql,template:$l,props:Zl,setup(e){let t=e.querySelector(`input`),n=e.querySelector(`.clear`),r=e.querySelector(`[name=dropdown]`),i=()=>n.style.display=t.value===``?`none`:`flex`;return r.onmousedown=e=>e.preventDefault(),t.onchange=()=>this.dispatchEvent(new Event(`change`)),n.onclick=()=>{t.value=``,i(),this.dispatchEvent(new Event(`input`)),this.dispatchEvent(new Event(`change`))},t.oninput=i,{expose:{get native(){return t}},value:{get:()=>t.value,set:e=>{t.value=e,i()}},placeholder:e=>t.placeholder=e,maxLength:e=>t.maxLength=e,readOnly:e=>t.readOnly=e}}}){}).define(Xl);var eu=`s-segmented-button`,tu=q({$value:``,mode:[`auto`,`fixed`]}),nu=`
:host{
  display: inline-flex;
  vertical-align: middle;
  align-items: center;
...
`,ru=`<slot></slot>`,iu=class extends J({style:nu,template:ru,props:tu,setup(e){let t=e.querySelector(`slot`),n=new fs({context:this,class:lu,slot:t}),r=getComputedStyle(this),i=()=>({easing:r.getPropertyValue(`--s-motion-easing-standard`)||`cubic-bezier(0.2, 0, 0, 1.0)`,duration:Wo(r.getPropertyValue(`--s-motion-duration-medium4`)||`400ms`)});return n.onUpdate=e=>{if(!e||!n.select||!this.isConnected)return;let t=e.shadowRoot.querySelector(`.indicator`).getBoundingClientRect(),r=n.select.shadowRoot.querySelector(`.indicator`),a=r.getBoundingClientRect(),o=t.left-a.left;r.style.transform=`translateX(${a.left>t.left?o:Math.abs(o)}px)`,r.style.width=`${t.width}px`,e.style.zIndex=`1`;let s=r.animate([{transform:`translateX(0)`,width:`${a.width}px`}],i());s.onfinish=s.oncancel=s.onremove=()=>{r.style.removeProperty(`transform`),r.style.removeProperty(`width`),e.style.removeProperty(`z-index`)}},{expose:{get options(){return n.list},get selectedIndex(){return n.selectedIndex}},value:{get:()=>n.value,set:e=>n.value=e}}}}){},au=`s-segmented-button-item`,ou=q({selected:!1,disabled:!1,selectable:!0,$value:``}),su=`
:host{
  display: flex;
  justify-content: center;
  align-items: center;
...
<slot name="end"></slot>
<s-ripple attached="true" part="ripple"></s-ripple>
`,lu=class extends J({style:su,template:cu,props:ou,setup(){return this.addEventListener(`click`,()=>{!(this.parentNode instanceof iu)||this.selected||this.selectable&&this.dispatchEvent(new Event(`${eu}:select`,{bubbles:!0}))}),{selected:()=>{this.parentNode instanceof iu&&this.dispatchEvent(new CustomEvent(`${eu}:update`,{bubbles:!0,detail:{}}))}}}}){};iu.define(eu),lu.define(au);var uu=`s-skeleton`,du=`
:host{
  display: block;
  height: 16px;
...
`;(class extends J({style:du}){}).define(uu);var fu=`s-slider`,pu=q({disabled:!1,$labeled:!1,$max:100,$min:0,$step:1,$value:0}),mu=`
:host{
  display: block;
  color: var(--s-color-primary, #006782);
  height: 16px;
...
<div class="container" part="container">
  ...
  <div class="handle" part="handle">
    ...
    <div class="label" part="label">${pu.value}</div>
  </div>
</div>
<input
  type="range"
  ...
  value="${pu.value}"
/>
`;(class extends J({style:mu,template:hu,props:pu,setup(e){let t=e.querySelector(`.container`),n=e.querySelector(`.indicator`),r=e.querySelector(`.track`),i=e.querySelector(`.handle`),a=e.querySelector(`.label`),o=e.querySelector(`input`),s=()=>{let e=Number(o.value),t=(e-this.min)*100/(this.max-this.min);i.style.left=`calc(${t}% - ${t*.16}px)`,n.style.width=`calc(${t}% - ${4+t*.16}px)`,r.style.width=`calc(${100-t}% - ${20-t*.16}px)`,a.textContent=String(e)};return o.onchange=()=>this.dispatchEvent(new Event(`change`)),o.oninput=()=>{this.value=Number(o.value),this.dispatchEvent(new Event(`input`))},o.onmousedown=e=>e.button===0&&Qo.pointerFine.matches&&t.classList.add(`active`),o.onmouseup=()=>Qo.pointerFine.matches&&t.classList.remove(`active`),o.ontouchstart=()=>Qo.pointerCoarse.matches&&t.classList.add(`active`),o.ontouchend=()=>Qo.pointerCoarse.matches&&t.classList.remove(`active`),o.ontouchcancel=()=>Qo.pointerCoarse.matches&&t.classList.remove(`active`),{max:e=>{o.max=String(e),s()},min:e=>{o.min=String(e),s()},step:e=>{o.step=String(e),s()},value:e=>{o.value=String(e),s()}}}}){}).define(fu);var gu=document.createElement(`div`);gu.setAttribute(`style`,`position: fixed;right: 0;bottom: 0;width: 100%;height: 100%;pointer-events: none`);const _u=e=>{e.appendChild(gu);let t=gu.getBoundingClientRect();return e.removeChild(gu),{left:t.left,top:t.top,width:t.width,height:t.height}};var vu=`s-snackbar`,yu=q({type:[`none`,`info`,`success`,`warning`,`error`],align:[`auto`,`top`,`bottom`],$duration:4e3}),bu=Oo({show:Event,showed:Event,closed:Event}),xu=`
:host{
  display: inline-block;
  vertical-align: middle;
}
...
`;(class extends J({style:Ou,template:ku,props:Du,setup(){this.addEventListener(`click`,()=>{this.checked=!this.checked,this.dispatchEvent(new Event(`change`))})}}){}).define(Eu);var Au=`s-tab`,ju=q({mode:[`scrollable`,`fixed`],$value:``}),Mu=`
:host{
  display: flex;
  justify-content: flex-start;
  position: relative;
...
`,Pu=class extends J({style:Mu,template:Nu,props:ju,setup(e){let t=e.querySelector(`slot`),n=e.querySelector(`.container`),r=new fs({context:this,class:zu,slot:t}),i=getComputedStyle(this),a=()=>({easing:i.getPropertyValue(`--s-motion-easing-standard`)||`cubic-bezier(0.2, 0, 0, 1.0)`,duration:Wo(i.getPropertyValue(`--s-motion-duration-medium4`)||`400ms`)});return r.onUpdate=e=>{if(r.select&&n.scrollWidth!==n.offsetWidth){let e=r.select.offsetLeft-n.offsetLeft-(n.offsetWidth/2-r.select.offsetWidth/2);n.scrollTo({left:e,behavior:`smooth`})}if(!e||!r.select||!this.isConnected)return;let t=e.shadowRoot.querySelector(`.indicator`).getBoundingClientRect(),i=r.select.shadowRoot?.querySelector(`.indicator`),o=i.getBoundingClientRect(),s=t.left-o.left;i.style.transform=`translateX(${o.left>t.left?s:Math.abs(s)}px)`,i.style.width=`${t.width}px`;let c=i.animate([{transform:`translateX(0)`,width:`${o.width}px`}],a());c.onfinish=c.oncancel=c.onremove=()=>{i.style.removeProperty(`transform`),i.style.removeProperty(`width`)}},{expose:{get options(){return r.list},get selectedIndex(){return r.selectedIndex}},value:{get:()=>r.value,set:e=>r.value=e}}}}){},Fu=`s-tab-item`,Iu=q({selected:!1,$value:``}),Lu=`
:host{
  display: flex;
  align-items: center;
  justify-content: center;
...
<s-ripple attached="true" part="ripple"></s-ripple>
`,zu=class extends J({style:Lu,template:Ru,props:Iu,setup(e){let t=e.querySelector(`.container`);return e.querySelector(`[name=icon]`).addEventListener(`slotchange`,e=>{let n=e.target.assignedElements().length;t.classList[n>0?`add`:`remove`](`icon`)}),this.addEventListener(`click`,()=>{!(this.parentNode instanceof Pu)||this.selected||this.dispatchEvent(new Event(`${Au}:select`,{bubbles:!0}))}),{selected:()=>{this.parentNode instanceof Pu&&this.dispatchEvent(new Event(`${Au}:update`,{bubbles:!0}))}}}}){};Pu.define(Au),zu.define(Fu);var Bu=`s-table`,Vu=`
:host{
  display: inline-block;
  font-size: .875rem;
  overflow: auto;
...
`,Hu=`
<slot></slot>
`,Uu=class extends J({style:Vu,template:Hu}){},Wu=`s-thead`,Gu=`
:host{
...
`,Ku=`<slot></slot>`,qu=class extends J({style:Gu,template:Ku}){},Ju=`s-tbody`,Yu=`
:host{
...
`,Xu=`<slot></slot>`,Zu=class extends J({style:Yu,template:Xu}){},Qu=`s-tr`,$u=`
:host{
  display: table-row;
}
`,ed=`<slot></slot>`,td=class extends J({style:$u,template:ed}){},nd=`s-th`,rd=`
:host{
  display: table-cell;
  padding: 12px 16px;
  text-transform: capitalize;
}
`,id=`<slot></slot>`,ad=class extends J({style:rd,template:id}){},od=`s-td`,sd=`
:host{
  display: table-cell;
  user-select: text;
  padding: 12px 16px;
}
`,cd=`<slot></slot>`,ld=class extends J({style:sd,template:cd}){};Uu.define(Bu),qu.define(Wu),Zu.define(Ju),td.define(Qu),ad.define(nd),ld.define(od);var ud=`s-text-field`,dd=q({$label:``,$placeholder:``,disabled:!1,type:[`text`,`number`,`password`,`multiline`],error:!1,$value:``,$maxLength:-1,readOnly:!1,multiLine:!1,countered:!1}),fd=`
:host{
  display: inline-grid;
  vertical-align: middle;
  font-size: .875rem;
...
`;(class extends J({style:fd,template:pd,props:dd,setup(e){let t=e.querySelector(`.field`),n=e.querySelector(`.label`),r=e.querySelector(`.shadow`),i=e.querySelector(`.counter`),a=e.querySelector(`.toggle`),o={input:e.querySelector(`input`),textarea:e.querySelector(`textarea`)},s=()=>this.type===`multiline`?o.textarea:o.input,c=()=>{this.countered&&(i.textContent=`${s().value.length}/${this.maxLength}`)},l=()=>this.dispatchEvent(new Event(`change`)),u=()=>{t.fixed=!0,t.focused=!0},d=()=>{t.focused=!1,s().value===``&&!this.error&&(t.fixed=!1)};o.input.oninput=c,o.input.onfocus=u,o.input.onblur=d,o.input.onchange=l,o.textarea.onfocus=u,o.textarea.onblur=d,o.textarea.onchange=l,o.textarea.oninput=()=>{r.textContent=o.textarea.value,c()};let f=e=>{this.value=`${parseInt(this.value||`0`)+e}`,this.dispatchEvent(new Event(`input`)),this.dispatchEvent(new Event(`change`))};return e.querySelector(`.up`).onclick=()=>f(1),e.querySelector(`.down`).onclick=()=>f(-1),e.querySelector(`.visibility`).onclick=()=>{o.input.type=a.classList.contains(`show-password`)?`password`:`text`,a.classList.toggle(`show-password`)},{expose:{get native(){return s()}},label:e=>n.textContent=e,type:(e,t)=>{o.input.type=e===`password`?a.classList.contains(`show-password`)?`text`:`password`:e,e===`multiline`&&(o.textarea.value=o.input.value,r.textContent=o.input.value),t===`multiline`&&(o.input.value=o.textarea.value)},error:e=>{if(e)return t.fixed=!0;s().value===``&&(t.fixed=!1)},value:{get:()=>s().value,set:e=>{o.input.value=e,o.textarea.value=e,r.textContent=e,c(),this.error||(t.fixed=e!==``)}},placeholder:e=>{o.input.placeholder=e,o.textarea.placeholder=e},readOnly:e=>{o.input.readOnly=e,o.textarea.readOnly=e},disabled:e=>{o.input.disabled=e,o.textarea.disabled=e},maxLength:e=>{o.input.maxLength=e,o.textarea.maxLength=e,c()},multiLine:e=>this.type=e?`multiline`:`text`,countered:c}}}){}).define(ud);var md=`s-tooltip`,hd=q({align:[`top`,`bottom`,`left`,`right`],disabled:!1}),gd=`
:host{
  display: inline-flex;
  vertical-align: middle;
  text-align: left;
...
`;(class extends J({style:gd,template:_d,props:hd,setup(e){let t=e.querySelector(`slot[name=trigger]`),n=e.querySelector(`.popup`),r=getComputedStyle(this),i=!1,a=()=>({easing:r.getPropertyValue(`--s-motion-easing-standard`)||`cubic-bezier(0.2, 0, 0, 1.0)`,duration:Wo(r.getPropertyValue(`--s-motion-duration-medium4`)||`400ms`)}),o=()=>{if(!this.isConnected||this.disabled)return;if(n.style.display=`block`,i=!0,n.showPopover)n.showPopover();else{let t=_u(e);n.style.marginLeft=`${-t.left}px`,n.style.marginTop=`${-t.top}px`,n.style.zIndex=`3`}let t=this.getBoundingClientRect(),r=n.offsetWidth,o=n.offsetHeight,s={top:0,left:0},c={middle(e){s.left=t.left-(r-t.width)/2;let n=()=>(s.top=t.top+t.height+4,s.top+o>innerHeight),i=()=>(s.top=t.top-o-4,s.top<0);s.left<0&&(s.left=t.left),s.left+r>innerWidth&&(s.left=t.left+t.width-r),e===`top`&&i()&&n(),e===`bottom`&&n()&&i()},left(){return s.left=t.left-r-4,s.top=t.top-(o-t.height)/2,s.left<0},right(){return s.left=t.left+t.width+4,s.top=t.top-(o-t.height)/2,s.left+r>innerWidth}};switch(this.align){case`bottom`:case`top`:c.middle(this.align);break;case`left`:c.left()&&c.right();break;case`right`:c.right()&&c.left();break}n.style.top=`${s.top}px`,n.style.left=`${s.left}px`,n.animate({opacity:[0,1]},a())},s=0,c=()=>{clearTimeout(s),i=!1,n.animate({opacity:[1,0]},a()).finished.then(()=>{i||(n.hidePopover&&n.hidePopover(),n.style.removeProperty(`display`))})};t.addEventListener(`touchstart`,()=>{Qo.pointerFine.matches||(clearTimeout(s),s=setTimeout(()=>o(),600))},{passive:!0}),t.ontouchend=()=>{clearTimeout(s),c()},t.onmouseenter=()=>Qo.pointerFine.matches&&o(),t.onmouseleave=()=>Qo.pointerFine.matches&&c()}}){}).define(md);var vd=typeof document<`u`;function yd(e){return typeof e==`object`||`displayName`in e||`props`in e||`__vccOpts`in e}function bd(e){return e.__esModule||e[Symbol.toStringTag]===`Module`||e.default&&yd(e.default)}var Y=Object.assign;function xd(e,t){let n={};for(let r in t){let i=t[r];n[r]=Cd(i)?i.map(e):e(i)}return n}var Sd=()=>{},Cd=Array.isArray;function wd(e,t){let n={};for(let r in e)n[r]=r in t?t[r]:e[r];return n}var Td=/#/g,Ed=/&/g,Dd=/\//g,Od=/=/g,kd=/\?/g,Ad=/\+/g,jd=/%5B/g,Md=/%5D/g,Nd=/%5E/g,Pd=/%60/g,Fd=/%7B/g,Id=/%7C/g,Ld=/%7D/g,Rd=/%20/g;function zd(e){return e==null?``:encodeURI(``+e).replace(Id,`|`).replace(jd,`[`).replace(Md,`]`)}function Bd(e){return zd(e).replace(Fd,`{`).replace(Ld,`}`).replace(Nd,`^`)}function Vd(e){return zd(e).replace(Ad,`%2B`).replace(Rd,`+`).replace(Td,`%23`).replace(Ed,`%26`).replace(Pd,"`").replace(Fd,`{`).replace(Ld,`}`).replace(Nd,`^`)}function Hd(e){return Vd(e).replace(Od,`%3D`)}function Ud(e){return zd(e).replace(Td,`%23`).replace(kd,`%3F`)}function Wd(e){return Ud(e).replace(Dd,`%2F`)}function Gd(e){if(e==null)return null;try{return decodeURIComponent(``+e)}catch{}return``+e}var Kd=/\/$/,qd=e=>e.replace(Kd,``);function Jd(e,t,n=`/`){let r,i={},a=``,o=``,s=t.indexOf(`#`),c=t.indexOf(`?`);return c=s>=0&&c>s?-1:c,c>=0&&(r=t.slice(0,c),a=t.slice(c,s>0?s:t.length),i=e(a.slice(1))),s>=0&&(r||=t.slice(0,s),o=t.slice(s,t.length)),r=nf(r??t,n),{fullPath:r+a+o,path:r,query:i,hash:Gd(o)}}function Yd(e,t){let n=t.query?e(t.query):``;return t.path+(n&&`?`)+n+(t.hash||``)}function Xd(e,t){return!t||!e.toLowerCase().startsWith(t.toLowerCase())?e:e.slice(t.length)||`/`}function Zd(e,t,n){let r=t.matched.length-1,i=n.matched.length-1;return r>-1&&r===i&&Qd(t.matched[r],n.matched[i])&&$d(t.params,n.params)&&e(t.query)===e(n.query)&&t.hash===n.hash}function Qd(e,t){return(e.aliasOf||e)===(t.aliasOf||t)}function $d(e,t){if(Object.keys(e).length!==Object.keys(t).length)return!1;for(let n in e)if(!ef(e[n],t[n]))return!1;return!0}function ef(e,t){return Cd(e)?tf(e,t):Cd(t)?tf(t,e):e===t}function tf(e,t){return Cd(t)?e.length===t.length&&e.every((e,n)=>e===t[n]):e.length===1&&e[0]===t}function nf(e,t){if(e.startsWith(`/`))return e;if(!e)return t;let n=t.split(`/`),r=e.split(`/`),i=r[r.length-1];(i===`..`||i===`.`)&&r.push(``);let a=n.length-1,o,s;for(o=0;o<r.length;o++)if(s=r[o],s!==`.`)if(s===`..`)a>1&&a--;else break;return n.slice(0,a).join(`/`)+`/`+r.slice(o).join(`/`)}var rf={path:`/`,name:void 0,params:{},query:{},hash:``,fullPath:`/`,matched:[],meta:{},redirectedFrom:void 0},af=function(e){return e.pop=`pop`,e.push=`push`,e}({}),of=function(e){return e.back=`back`,e.forward=`forward`,e.unknown=``,e}({});function sf(e){if(!e)if(vd){let t=document.querySelector(`base`);e=t&&t.getAttribute(`href`)||`/`,e=e.replace(/^\w+:\/\/[^\/]+/,``)}else e=`/`;return e[0]!==`/`&&e[0]!==`#`&&(e=`/`+e),qd(e)}var cf=/^[^#]+#/;function lf(e,t){return e.replace(cf,`#`)+t}function uf(e,t){let n=document.documentElement.getBoundingClientRect(),r=e.getBoundingClientRect();return{behavior:t.behavior,left:r.left-n.left-(t.left||0),top:r.top-n.top-(t.top||0)}}var df=()=>({left:window.scrollX,top:window.scrollY});function ff(e){let t;if(`el`in e){let n=e.el,r=typeof n==`string`&&n.startsWith(`#`),i=typeof n==`string`?r?document.getElementById(n.slice(1)):document.querySelector(n):n;if(!i)return;t=uf(i,e)}else t=e;`scrollBehavior`in document.documentElement.style?window.scrollTo(t):window.scrollTo(t.left==null?window.scrollX:t.left,t.top==null?window.scrollY:t.top)}function pf(e,t){return(history.state?history.state.position-t:-1)+e}var mf=new Map;function hf(e,t){mf.set(e,t)}function gf(e){let t=mf.get(e);return mf.delete(e),t}function _f(e){return typeof e==`string`||e&&typeof e==`object`}function vf(e){return typeof e==`string`||typeof e==`symbol`}var X=function(e){return e[e.MATCHER_NOT_FOUND=1]=`MATCHER_NOT_FOUND`,e[e.NAVIGATION_GUARD_REDIRECT=2]=`NAVIGATION_GUARD_REDIRECT`,e[e.NAVIGATION_ABORTED=4]=`NAVIGATION_ABORTED`,e[e.NAVIGATION_CANCELLED=8]=`NAVIGATION_CANCELLED`,e[e.NAVIGATION_DUPLICATED=16]=`NAVIGATION_DUPLICATED`,e}({}),yf=Symbol(``);X.MATCHER_NOT_FOUND,X.NAVIGATION_GUARD_REDIRECT,X.NAVIGATION_ABORTED,X.NAVIGATION_CANCELLED,X.NAVIGATION_DUPLICATED;function bf(e,t){return Y(Error(),{type:e,[yf]:!0},t)}function xf(e,t){return e instanceof Error&&yf in e&&(t==null||!!(e.type&t))}function Sf(e){let t={};if(e===``||e===`?`)return t;let n=(e[0]===`?`?e.slice(1):e).split(`&`);for(let e=0;e<n.length;++e){let r=n[e].replace(Ad,` `),i=r.indexOf(`=`),a=Gd(i<0?r:r.slice(0,i)),o=i<0?null:Gd(r.slice(i+1));if(a in t){let e=t[a];Cd(e)||(e=t[a]=[e]),e.push(o)}else t[a]=o}return t}function Cf(e){let t=``;for(let n in e){let r=e[n];if(n=Hd(n),r==null){r!==void 0&&(t+=(t.length?`&`:``)+n);continue}(Cd(r)?r.map(e=>e&&Vd(e)):[r&&Vd(r)]).forEach(e=>{e!==void 0&&(t+=(t.length?`&`:``)+n,e!=null&&(t+=`=`+e))})}return t}function wf(e){let t={};for(let n in e){let r=e[n];r!==void 0&&(t[n]=Cd(r)?r.map(e=>e==null?null:``+e):r==null?r:``+r)}return t}var Tf=Symbol(``),Ef=Symbol(``),Df=Symbol(``),Of=Symbol(``),kf=Symbol(``);function Af(){let e=[];function t(t){return e.push(t),()=>{let n=e.indexOf(t);n>-1&&e.splice(n,1)}}function n(){e=[]}return{add:t,list:()=>e.slice(),reset:n}}function jf(e,t,n,r,i,a=e=>e()){let o=r&&(r.enterCallbacks[i]=r.enterCallbacks[i]||[]);return()=>new Promise((s,c)=>{let l=e=>{e===!1?c(bf(X.NAVIGATION_ABORTED,{from:n,to:t})):e instanceof Error?c(e):_f(e)?c(bf(X.NAVIGATION_GUARD_REDIRECT,{from:t,to:e})):(o&&r.enterCallbacks[i]===o&&typeof e==`function`&&o.push(e),s())},u=a(()=>e.call(r&&r.instances[i],t,n,l)),d=Promise.resolve(u);e.length<3&&(d=d.then(l)),d.catch(e=>c(e))})}function Mf(e,t,n,r,i=e=>e()){let a=[];for(let o of e)for(let e in o.components){let s=o.components[e];if(!(t!==`beforeRouteEnter`&&!o.instances[e]))if(yd(s)){let c=(s.__vccOpts||s)[t];c&&a.push(jf(c,n,r,o,e,i))}else{let c=s();a.push(()=>c.then(a=>{if(!a)throw Error(`Couldn't resolve component "${e}" at "${o.path}"`);let s=bd(a)?a.default:a;o.mods[e]=a,o.components[e]=s;let c=(s.__vccOpts||s)[t];return c&&jf(c,n,r,o,e,i)()}))}}return a}function Nf(e,t){let n=[],r=[],i=[],a=Math.max(t.matched.length,e.matched.length);for(let o=0;o<a;o++){let a=t.matched[o];a&&(e.matched.find(e=>Qd(e,a))?r.push(a):n.push(a));let s=e.matched[o];s&&(t.matched.find(e=>Qd(e,s))||i.push(s))}return[n,r,i]}var Pf=()=>location.protocol+`//`+location.host;function Ff(e,t){let{pathname:n,search:r,hash:i}=t,a=e.indexOf(`#`);if(a>-1){let t=i.includes(e.slice(a))?e.slice(a).length:1,n=i.slice(t);return n[0]!==`/`&&(n=`/`+n),Xd(n,``)}return Xd(n,e)+r+i}function If(e,t,n,r){let i=[],a=[],o=null,s=({state:a})=>{let s=Ff(e,location),c=n.value,l=t.value,u=0;if(a){if(n.value=s,t.value=a,o&&o===c){o=null;return}u=l?a.position-l.position:0}else r(s);i.forEach(e=>{e(n.value,c,{delta:u,type:af.pop,direction:u?u>0?of.forward:of.back:of.unknown})})};function c(){o=n.value}function l(e){i.push(e);let t=()=>{let t=i.indexOf(e);t>-1&&i.splice(t,1)};return a.push(t),t}function u(){if(document.visibilityState===`hidden`){let{history:e}=window;if(!e.state)return;e.replaceState(Y({},e.state,{scroll:df()}),``)}}function d(){for(let e of a)e();a=[],window.removeEventListener(`popstate`,s),window.removeEventListener(`pagehide`,u),document.removeEventListener(`visibilitychange`,u)}return window.addEventListener(`popstate`,s),window.addEventListener(`pagehide`,u),document.addEventListener(`visibilitychange`,u),{pauseListeners:c,listen:l,destroy:d}}function Lf(e,t,n,r=!1,i=!1){return{back:e,current:t,forward:n,replaced:r,position:window.history.length,scroll:i?df():null}}function Rf(e){let{history:t,location:n}=window,r={value:Ff(e,n)},i={value:t.state};i.value||a(r.value,{back:null,current:r.value,forward:null,position:t.length-1,replaced:!0,scroll:null},!0);function a(r,a,o){let s=e.indexOf(`#`),c=s>-1?(n.host&&document.querySelector(`base`)?e:e.slice(s))+r:Pf()+e+r;try{t[o?`replaceState`:`pushState`](a,``,c),i.value=a}catch(e){console.error(e),n[o?`replace`:`assign`](c)}}function o(e,n){a(e,Y({},t.state,Lf(i.value.back,e,i.value.forward,!0),n,{position:i.value.position}),!0),r.value=e}function s(e,n){let o=Y({},i.value,t.state,{forward:e,scroll:df()});a(o.current,o,!0),a(e,Y({},Lf(r.value,e,null),{position:o.position+1},n),!1),r.value=e}return{location:r,state:i,push:s,replace:o}}function zf(e){e=sf(e);let t=Rf(e),n=If(e,t.state,t.location,t.replace);function r(e,t=!0){t||n.pauseListeners(),history.go(e)}let i=Y({location:``,base:e,go:r,createHref:lf.bind(null,e)},t,n);return Object.defineProperty(i,`location`,{enumerable:!0,get:()=>t.location.value}),Object.defineProperty(i,`state`,{enumerable:!0,get:()=>t.state.value}),i}function Bf(e){return e=location.host?e||location.pathname+location.search:``,e.includes(`#`)||(e+=`#`),zf(e)}var Vf=function(e){return e[e.Static=0]=`Static`,e[e.Param=1]=`Param`,e[e.Group=2]=`Group`,e}({}),Z=function(e){return e[e.Static=0]=`Static`,e[e.Param=1]=`Param`,e[e.ParamRegExp=2]=`ParamRegExp`,e[e.ParamRegExpEnd=3]=`ParamRegExpEnd`,e[e.EscapeNext=4]=`EscapeNext`,e}(Z||{}),Hf={type:Vf.Static,value:``},Uf=/[a-zA-Z0-9_]/;function Wf(e){if(!e)return[[]];if(e===`/`)return[[Hf]];if(!e.startsWith(`/`))throw Error(`Invalid path "${e}"`);function t(e){throw Error(`ERR (${n})/"${l}": ${e}`)}let n=Z.Static,r=n,i=[],a;function o(){a&&i.push(a),a=[]}let s=0,c,l=``,u=``;function d(){l&&=(n===Z.Static?a.push({type:Vf.Static,value:l}):n===Z.Param||n===Z.ParamRegExp||n===Z.ParamRegExpEnd?(a.length>1&&(c===`*`||c===`+`)&&t(`A repeatable param (${l}) must be alone in its segment. eg: '/:ids+.`),a.push({type:Vf.Param,value:l,regexp:u,repeatable:c===`*`||c===`+`,optional:c===`*`||c===`?`})):t(`Invalid state to consume buffer`),``)}function f(){l+=c}for(;s<e.length;){if(c=e[s++],c===`\\`&&n!==Z.ParamRegExp){r=n,n=Z.EscapeNext;continue}switch(n){case Z.Static:c===`/`?(l&&d(),o()):c===`:`?(d(),n=Z.Param):f();break;case Z.EscapeNext:f(),n=r;break;case Z.Param:c===`(`?n=Z.ParamRegExp:Uf.test(c)?f():(d(),n=Z.Static,c!==`*`&&c!==`?`&&c!==`+`&&s--);break;case Z.ParamRegExp:c===`)`?u[u.length-1]==`\\`?u=u.slice(0,-1)+c:n=Z.ParamRegExpEnd:u+=c;break;case Z.ParamRegExpEnd:d(),n=Z.Static,c!==`*`&&c!==`?`&&c!==`+`&&s--,u=``;break;default:t(`Unknown state`);break}}return n===Z.ParamRegExp&&t(`Unfinished custom RegExp for param "${l}"`),d(),o(),i}var Gf=`[^/]+?`,Kf={sensitive:!1,strict:!1,start:!0,end:!0},qf=function(e){return e[e._multiplier=10]=`_multiplier`,e[e.Root=90]=`Root`,e[e.Segment=40]=`Segment`,e[e.SubSegment=30]=`SubSegment`,e[e.Static=40]=`Static`,e[e.Dynamic=20]=`Dynamic`,e[e.BonusCustomRegExp=10]=`BonusCustomRegExp`,e[e.BonusWildcard=-50]=`BonusWildcard`,e[e.BonusRepeatable=-20]=`BonusRepeatable`,e[e.BonusOptional=-8]=`BonusOptional`,e[e.BonusStrict=.7000000000000001]=`BonusStrict`,e[e.BonusCaseSensitive=.25]=`BonusCaseSensitive`,e}(qf||{}),Jf=/[.+*?^${}()[\]/\\]/g;function Yf(e,t){let n=Y({},Kf,t),r=[],i=n.start?`^`:``,a=[];for(let t of e){let e=t.length?[]:[qf.Root];n.strict&&!t.length&&(i+=`/`);for(let r=0;r<t.length;r++){let o=t[r],s=qf.Segment+(n.sensitive?qf.BonusCaseSensitive:0);if(o.type===Vf.Static)r||(i+=`/`),i+=o.value.replace(Jf,`\\$&`),s+=qf.Static;else if(o.type===Vf.Param){let{value:e,repeatable:n,optional:c,regexp:l}=o;a.push({name:e,repeatable:n,optional:c});let u=l||Gf;if(u!==Gf){s+=qf.BonusCustomRegExp;try{`${u}`}catch(t){throw Error(`Invalid custom RegExp for param "${e}" (${u}): `+t.message)}}let d=n?`((?:${u})(?:/(?:${u}))*)`:`(${u})`;r||(d=c&&t.length<2?`(?:/${d})`:`/`+d),c&&(d+=`?`),i+=d,s+=qf.Dynamic,c&&(s+=qf.BonusOptional),n&&(s+=qf.BonusRepeatable),u===`.*`&&(s+=qf.BonusWildcard)}e.push(s)}r.push(e)}if(n.strict&&n.end){let e=r.length-1;r[e][r[e].length-1]+=qf.BonusStrict}n.strict||(i+=`/?`),n.end?i+=`$`:n.strict&&!i.endsWith(`/`)&&(i+=`(?:/|$)`);let o=new RegExp(i,n.sensitive?``:`i`);function s(e){let t=e.match(o),n={};if(!t)return null;for(let e=1;e<t.length;e++){let r=t[e]||``,i=a[e-1];n[i.name]=r&&i.repeatable?r.split(`/`):r}return n}function c(t){let n=``,r=!1;for(let i of e){(!r||!n.endsWith(`/`))&&(n+=`/`),r=!1;for(let e of i)if(e.type===Vf.Static)n+=e.value;else if(e.type===Vf.Param){let{value:a,repeatable:o,optional:s}=e,c=a in t?t[a]:``;if(Cd(c)&&!o)throw Error(`Provided param "${a}" is an array but it is not repeatable (* or + modifiers)`);let l=Cd(c)?c.join(`/`):c;if(!l)if(s)i.length<2&&(n.endsWith(`/`)?n=n.slice(0,-1):r=!0);else throw Error(`Missing required param "${a}"`);n+=l}}return n||`/`}return{re:o,score:r,keys:a,parse:s,stringify:c}}function Xf(e,t){let n=0;for(;n<e.length&&n<t.length;){let r=t[n]-e[n];if(r)return r;n++}return e.length<t.length?e.length===1&&e[0]===qf.Static+qf.Segment?-1:1:e.length>t.length?t.length===1&&t[0]===qf.Static+qf.Segment?1:-1:0}function Zf(e,t){let n=0,r=e.score,i=t.score;for(;n<r.length&&n<i.length;){let e=Xf(r[n],i[n]);if(e)return e;n++}if(Math.abs(i.length-r.length)===1){if(Qf(r))return 1;if(Qf(i))return-1}return i.length-r.length}function Qf(e){let t=e[e.length-1];return e.length>0&&t[t.length-1]<0}var $f={strict:!1,end:!0,sensitive:!1};function ep(e,t,n){let r=Y(Yf(Wf(e.path),n),{record:e,parent:t,children:[],alias:[]});return t&&!r.record.aliasOf==!t.record.aliasOf&&t.children.push(r),r}function tp(e,t){let n=[],r=new Map;t=wd($f,t);function i(e){return r.get(e)}function a(e,n,r){let i=!r,s=rp(e);s.aliasOf=r&&r.record;let l=wd(t,e),u=[s];if(`alias`in e){let t=typeof e.alias==`string`?[e.alias]:e.alias;for(let e of t)u.push(rp(Y({},s,{components:r?r.record.components:s.components,path:e,aliasOf:r?r.record:s})))}let d,f;for(let t of u){let{path:u}=t;if(n&&u[0]!==`/`){let e=n.record.path,r=e[e.length-1]===`/`?``:`/`;t.path=n.record.path+(u&&r+u)}if(d=ep(t,n,l),r?r.alias.push(d):(f||=d,f!==d&&f.alias.push(d),i&&e.name&&!ap(d)&&o(e.name)),lp(d)&&c(d),s.children){let e=s.children;for(let t=0;t<e.length;t++)a(e[t],d,r&&r.children[t])}r||=d}return f?()=>{o(f)}:Sd}function o(e){if(vf(e)){let t=r.get(e);t&&(r.delete(e),n.splice(n.indexOf(t),1),t.children.forEach(o),t.alias.forEach(o))}else{let t=n.indexOf(e);t>-1&&(n.splice(t,1),e.record.name&&r.delete(e.record.name),e.children.forEach(o),e.alias.forEach(o))}}function s(){return n}function c(e){let t=sp(e,n);n.splice(t,0,e),e.record.name&&!ap(e)&&r.set(e.record.name,e)}function l(e,t){let i,a={},o,s;if(`name`in e&&e.name){if(i=r.get(e.name),!i)throw bf(X.MATCHER_NOT_FOUND,{location:e});s=i.record.name,a=Y(np(t.params,i.keys.filter(e=>!e.optional).concat(i.parent?i.parent.keys.filter(e=>e.optional):[]).map(e=>e.name)),e.params&&np(e.params,i.keys.map(e=>e.name))),o=i.stringify(a)}else if(e.path!=null)o=e.path,i=n.find(e=>e.re.test(o)),i&&(a=i.parse(o),s=i.record.name);else{if(i=t.name?r.get(t.name):n.find(e=>e.re.test(t.path)),!i)throw bf(X.MATCHER_NOT_FOUND,{location:e,currentLocation:t});s=i.record.name,a=Y({},t.params,e.params),o=i.stringify(a)}let c=[],l=i;for(;l;)c.unshift(l.record),l=l.parent;return{name:s,path:o,params:a,matched:c,meta:op(c)}}e.forEach(e=>a(e));function u(){n.length=0,r.clear()}return{addRoute:a,resolve:l,removeRoute:o,clearRoutes:u,getRoutes:s,getRecordMatcher:i}}function np(e,t){let n={};for(let r of t)r in e&&(n[r]=e[r]);return n}function rp(e){let t={path:e.path,redirect:e.redirect,name:e.name,meta:e.meta||{},aliasOf:e.aliasOf,beforeEnter:e.beforeEnter,props:ip(e),children:e.children||[],instances:{},leaveGuards:new Set,updateGuards:new Set,enterCallbacks:{},components:`components`in e?e.components||null:e.component&&{default:e.component}};return Object.defineProperty(t,`mods`,{value:{}}),t}function ip(e){let t={},n=e.props||!1;if(`component`in e)t.default=n;else for(let r in e.components)t[r]=typeof n==`object`?n[r]:n;return t}function ap(e){for(;e;){if(e.record.aliasOf)return!0;e=e.parent}return!1}function op(e){return e.reduce((e,t)=>Y(e,t.meta),{})}function sp(e,t){let n=0,r=t.length;for(;n!==r;){let i=n+r>>1;Zf(e,t[i])<0?r=i:n=i+1}let i=cp(e);return i&&(r=t.lastIndexOf(i,r-1)),r}function cp(e){let t=e;for(;t=t.parent;)if(lp(t)&&Zf(e,t)===0)return t}function lp({record:e}){return!!(e.name||e.components&&Object.keys(e.components).length||e.redirect)}function up(e){let t=Br(Df),n=Br(Of),r=K(()=>{let n=Yt(e.to);return t.resolve(n)}),i=K(()=>{let{matched:e}=r.value,{length:t}=e,i=e[t-1],a=n.matched;if(!i||!a.length)return-1;let o=a.findIndex(Qd.bind(null,i));if(o>-1)return o;let s=hp(e[t-2]);return t>1&&hp(i)===s&&a[a.length-1].path!==s?a.findIndex(Qd.bind(null,e[t-2])):o}),a=K(()=>i.value>-1&&mp(n.params,r.value.params)),o=K(()=>i.value>-1&&i.value===n.matched.length-1&&$d(n.params,r.value.params));function s(n={}){if(pp(n)){let n=t[Yt(e.replace)?`replace`:`push`](Yt(e.to)).catch(Sd);return e.viewTransition&&typeof document<`u`&&`startViewTransition`in document&&document.startViewTransition(()=>n),n}return Promise.resolve()}return{route:r,href:K(()=>r.value.href),isActive:a,isExactActive:o,navigate:s}}function dp(e){return e.length===1?e[0]:e}var fp=Fn({name:`RouterLink`,compatConfig:{MODE:3},props:{to:{type:[String,Object],required:!0},replace:Boolean,activeClass:String,exactActiveClass:String,custom:Boolean,ariaCurrentValue:{type:String,default:`page`},viewTransition:Boolean},useLink:up,setup(e,{slots:t}){let n=Ft(up(e)),{options:r}=Br(Df),i=K(()=>({[gp(e.activeClass,r.linkActiveClass,`router-link-active`)]:n.isActive,[gp(e.exactActiveClass,r.linkExactActiveClass,`router-link-exact-active`)]:n.isExactActive}));return()=>{let r=t.default&&dp(t.default(n));return e.custom?r:Ca(`a`,{"aria-current":n.isExactActive?e.ariaCurrentValue:null,href:n.href,onClick:n.navigate,class:i.value},r)}}});function pp(e){if(!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)&&!e.defaultPrevented&&!(e.button!==void 0&&e.button!==0)){if(e.currentTarget&&e.currentTarget.getAttribute){let t=e.currentTarget.getAttribute(`target`);if(/\b_blank\b/i.test(t))return}return e.preventDefault&&e.preventDefault(),!0}}function mp(e,t){for(let n in t){let r=t[n],i=e[n];if(typeof r==`string`){if(r!==i)return!1}else if(!Cd(i)||i.length!==r.length||r.some((e,t)=>e!==i[t]))return!1}return!0}function hp(e){return e?e.aliasOf?e.aliasOf.path:e.path:``}var gp=(e,t,n)=>e??t??n,_p=Fn({name:`RouterView`,inheritAttrs:!1,props:{name:{type:String,default:`default`},route:Object},compatConfig:{MODE:3},setup(e,{attrs:t,slots:n}){let r=Br(kf),i=K(()=>e.route||r.value),a=Br(Ef,0),o=K(()=>{let e=Yt(a),{matched:t}=i.value,n;for(;(n=t[e])&&!n.components;)e++;return e}),s=K(()=>i.value.matched[o.value]);zr(Ef,K(()=>o.value+1)),zr(Tf,s),zr(kf,i);let c=M();return Ur(()=>[c.value,s.value,e.name],([e,t,n],[r,i,a])=>{t&&(t.instances[n]=e,i&&i!==t&&e&&e===r&&(t.leaveGuards.size||(t.leaveGuards=i.leaveGuards),t.updateGuards.size||(t.updateGuards=i.updateGuards))),e&&t&&(!i||!Qd(t,i)||!r)&&(t.enterCallbacks[n]||[]).forEach(t=>t(e))},{flush:`post`}),()=>{let r=i.value,a=e.name,o=s.value,l=o&&o.components[a];if(!l)return vp(n.default,{Component:l,route:r});let u=o.props[a],d=Ca(l,Y({},u?u===!0?r.params:typeof u==`function`?u(r):u:null,t,{onVnodeUnmounted:e=>{e.component.isUnmounted&&(o.instances[a]=null)},ref:c}));return vp(n.default,{Component:d,route:r})||d}}});function vp(e,t){if(!e)return null;let n=e(t);return n.length===1?n[0]:n}var yp=_p;function bp(e){let t=tp(e.routes,e),n=e.parseQuery||Sf,r=e.stringifyQuery||Cf,i=e.history,a=Af(),o=Af(),s=Af(),c=Kt(rf),l=rf;vd&&e.scrollBehavior&&`scrollRestoration`in history&&(history.scrollRestoration=`manual`);let u=xd.bind(null,e=>``+e),d=xd.bind(null,Wd),f=xd.bind(null,Gd);function p(e,n){let r,i;return vf(e)?(r=t.getRecordMatcher(e),i=n):i=e,t.addRoute(i,r)}function m(e){let n=t.getRecordMatcher(e);n&&t.removeRoute(n)}function h(){return t.getRoutes().map(e=>e.record)}function g(e){return!!t.getRecordMatcher(e)}function _(e,a){if(a=Y({},a||c.value),typeof e==`string`){let r=Jd(n,e,a.path),o=t.resolve({path:r.path},a),s=i.createHref(r.fullPath);return Y(r,o,{params:f(o.params),hash:Gd(r.hash),redirectedFrom:void 0,href:s})}let o;if(e.path!=null)o=Y({},e,{path:Jd(n,e.path,a.path).path});else{let t=Y({},e.params);for(let e in t)t[e]??delete t[e];o=Y({},e,{params:d(t)}),a.params=d(a.params)}let s=t.resolve(o,a),l=e.hash||``;s.params=u(f(s.params));let p=Yd(r,Y({},e,{hash:Bd(l),path:s.path})),m=i.createHref(p);return Y({fullPath:p,hash:l,query:r===Cf?wf(e.query):e.query||{}},s,{redirectedFrom:void 0,href:m})}function v(e){return typeof e==`string`?Jd(n,e,c.value.path):Y({},e)}function y(e,t){if(l!==e)return bf(X.NAVIGATION_CANCELLED,{from:t,to:e})}function b(e){return S(e)}function x(e){return b(Y(v(e),{replace:!0}))}function ee(e,t){let n=e.matched[e.matched.length-1];if(n&&n.redirect){let{redirect:r}=n,i=typeof r==`function`?r(e,t):r;return typeof i==`string`&&(i=i.includes(`?`)||i.includes(`#`)?i=v(i):{path:i},i.params={}),Y({query:e.query,hash:e.hash,params:i.path==null?e.params:{}},i)}}function S(e,t){let n=l=_(e),i=c.value,a=e.state,o=e.force,s=e.replace===!0,u=ee(n,i);if(u)return S(Y(v(u),{state:typeof u==`object`?Y({},a,u.state):a,force:o,replace:s}),t||n);let d=n;d.redirectedFrom=t;let f;return!o&&Zd(r,i,n)&&(f=bf(X.NAVIGATION_DUPLICATED,{to:d,from:i}),fe(i,i,!0,!1)),(f?Promise.resolve(f):re(d,i)).catch(e=>xf(e)?xf(e,X.NAVIGATION_GUARD_REDIRECT)?e:de(e):ue(e,d,i)).then(e=>{if(e){if(xf(e,X.NAVIGATION_GUARD_REDIRECT))return S(Y({replace:s},v(e.to),{state:typeof e.to==`object`?Y({},a,e.to.state):a,force:o}),t||d)}else e=C(d,i,!0,s,a);return ie(d,i,e),e})}function te(e,t){let n=y(e,t);return n?Promise.reject(n):Promise.resolve()}function ne(e){let t=me.values().next().value;return t&&typeof t.runWithContext==`function`?t.runWithContext(e):e()}function re(e,t){let n,[r,i,s]=Nf(e,t);n=Mf(r.reverse(),`beforeRouteLeave`,e,t);for(let i of r)i.leaveGuards.forEach(r=>{n.push(jf(r,e,t))});let c=te.bind(null,e,t);return n.push(c),ge(n).then(()=>{n=[];for(let r of a.list())n.push(jf(r,e,t));return n.push(c),ge(n)}).then(()=>{n=Mf(i,`beforeRouteUpdate`,e,t);for(let r of i)r.updateGuards.forEach(r=>{n.push(jf(r,e,t))});return n.push(c),ge(n)}).then(()=>{n=[];for(let r of s)if(r.beforeEnter)if(Cd(r.beforeEnter))for(let i of r.beforeEnter)n.push(jf(i,e,t));else n.push(jf(r.beforeEnter,e,t));return n.push(c),ge(n)}).then(()=>(e.matched.forEach(e=>e.enterCallbacks={}),n=Mf(s,`beforeRouteEnter`,e,t,ne),n.push(c),ge(n))).then(()=>{n=[];for(let r of o.list())n.push(jf(r,e,t));return n.push(c),ge(n)}).catch(e=>xf(e,X.NAVIGATION_CANCELLED)?e:Promise.reject(e))}function ie(e,t,n){s.list().forEach(r=>ne(()=>r(e,t,n)))}function C(e,t,n,r,a){let o=y(e,t);if(o)return o;let s=t===rf,l=vd?history.state:{};n&&(r||s?i.replace(e.fullPath,Y({scroll:s&&l&&l.scroll},a)):i.push(e.fullPath,a)),c.value=e,fe(e,t,n,s),de()}let ae;function oe(){ae||=i.listen((e,t,n)=>{if(!he.listening)return;let r=_(e),a=ee(r,he.currentRoute.value);if(a){S(Y(a,{replace:!0,force:!0}),r).catch(Sd);return}l=r;let o=c.value;vd&&hf(pf(o.fullPath,n.delta),df()),re(r,o).catch(e=>xf(e,X.NAVIGATION_ABORTED|X.NAVIGATION_CANCELLED)?e:xf(e,X.NAVIGATION_GUARD_REDIRECT)?(S(Y(v(e.to),{force:!0}),r).then(e=>{xf(e,X.NAVIGATION_ABORTED|X.NAVIGATION_DUPLICATED)&&!n.delta&&n.type===af.pop&&i.go(-1,!1)}).catch(Sd),Promise.reject()):(n.delta&&i.go(-n.delta,!1),ue(e,r,o))).then(e=>{e||=C(r,o,!1),e&&(n.delta&&!xf(e,X.NAVIGATION_CANCELLED)?i.go(-n.delta,!1):n.type===af.pop&&xf(e,X.NAVIGATION_ABORTED|X.NAVIGATION_DUPLICATED)&&i.go(-1,!1)),ie(r,o,e)}).catch(Sd)})}let se=Af(),ce=Af(),le;function ue(e,t,n){de(e);let r=ce.list();return r.length?r.forEach(r=>r(e,t,n)):console.error(e),Promise.reject(e)}function w(){return le&&c.value!==rf?Promise.resolve():new Promise((e,t)=>{se.add([e,t])})}function de(e){return le||(le=!e,oe(),se.list().forEach(([t,n])=>e?n(e):t()),se.reset()),e}function fe(t,n,r,i){let{scrollBehavior:a}=e;if(!vd||!a)return Promise.resolve();let o=!r&&gf(pf(t.fullPath,0))||(i||!r)&&history.state&&history.state.scroll||null;return _n().then(()=>a(t,n,o)).then(e=>e&&ff(e)).catch(e=>ue(e,t,n))}let pe=e=>i.go(e),T,me=new Set,he={currentRoute:c,listening:!0,addRoute:p,removeRoute:m,clearRoutes:t.clearRoutes,hasRoute:g,getRoutes:h,resolve:_,options:e,push:b,replace:x,go:pe,back:()=>pe(-1),forward:()=>pe(1),beforeEach:a.add,beforeResolve:o.add,afterEach:s.add,onError:ce.add,isReady:w,install(e){e.component(`RouterLink`,fp),e.component(`RouterView`,yp),e.config.globalProperties.$router=he,Object.defineProperty(e.config.globalProperties,`$route`,{enumerable:!0,get:()=>Yt(c)}),vd&&!T&&c.value===rf&&(T=!0,b(i.location).catch(e=>{}));let t={};for(let e in rf)Object.defineProperty(t,e,{get:()=>c.value[e],enumerable:!0});e.provide(Df,he),e.provide(Of,It(t)),e.provide(kf,c);let n=e.unmount;me.add(e),e.unmount=function(){me.delete(e),me.size<1&&(l=rf,ae&&ae(),ae=null,c.value=rf,T=!1,le=!1),n()}}};function ge(e){return e.reduce((e,t)=>e.then(()=>ne(t)),Promise.resolve())}return he}function xp(){return Br(Df)}function Sp(e){return Br(Of)}var Cp=`material-symbols-style`,Q={__name:`MaterialSymbol`,props:{icon:{type:String,required:!0},family:{type:String,default:`rounded`,validator:e=>[`outlined`,`rounded`,`sharp`].includes(e)},fill:{type:Boolean,default:!1},weight:{type:Number,default:400},grade:{type:Number,default:0},size:{type:[Number,String],default:24},color:{type:String,default:void 0},alignText:{type:Boolean,default:!1}},setup(e){if(typeof document<`u`&&!document.getElementById(Cp)){let e=document.createElement(`style`);e.id=Cp,e.innerHTML=`
